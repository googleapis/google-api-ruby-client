...
shared_examples_for 'configurable user agent' do
  ...
  it 'should allow the user agent to be modified' do
    ...
    expect(client.user_agent).to be == 'Custom User Agent/1.2.3'
  end
  ...
  it 'should transmit a User-Agent header when sending requests' do
    ...
    conn = stub_connection do |stub|
      stub.get('/') do |env|
        ...
        expect(headers['User-Agent']).to be == client.user_agent
        [200, {}, ['']]
      end
    end
...
describe Google::APIClient do
  ...
  describe 'configured for OAuth 1' do
    ...
    it 'should use the default OAuth1 client configuration' do
      expect(client.authorization.temporary_credential_uri.to_s).to be == (
        'https://www.google.com/accounts/OAuthGetRequestToken')
      expect(client.authorization.authorization_uri.to_s).to include(
        'https://www.google.com/accounts/OAuthAuthorizeToken'
      )
      expect(client.authorization.token_credential_uri.to_s).to be == (
        'https://www.google.com/accounts/OAuthGetAccessToken')
      expect(client.authorization.client_credential_key).to be == 'anonymous'
      expect(client.authorization.client_credential_secret).to be == 'anonymous'
    end
    ...
    before do
      ...
      @connection = stub_connection do |stub|
        stub.post('/prediction/v1.2/training?data=12345') do |env|
          expect(env[:request_headers]['Authorization']).to be == 'Bearer 12345'
          [200, {}, '{}']
        end
      end
    end
