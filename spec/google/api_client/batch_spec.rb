...
describe Google::APIClient::BatchRequest do
  ...
  it 'raises an error if making an empty batch request' do
  ...
  it 'allows query parameters in batch requests' do
    batch = Google::APIClient::BatchRequest.new
  ...
  describe 'with the discovery API' do
    ...
    describe 'with two valid requests' do
      ...
      it 'raises an error if using the same call ID more than once' do
        batch = Google::APIClient::BatchRequest.new
  ...
  describe 'with the calendar API' do
    ...
    describe 'with two valid requests' do
      ...
      it 'converts to a correct HTTP request' do
