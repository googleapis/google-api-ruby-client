# Legacy REST client for version V1 of the Identity and Access Management (IAM) API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Iam service in particular.)
