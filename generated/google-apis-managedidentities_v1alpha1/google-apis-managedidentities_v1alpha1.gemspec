...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Legacy REST client for Managed Service for Microsoft Active Directory API V1alpha1"
  gem.description =
      "This is the legacy REST client for Managed Service for Microsoft Active Directory API V1alpha1." \
