require File.expand_path("lib/google/apis/networksecurity_v1beta1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-networksecurity_v1beta1"
  gem.version = Google::Apis::NetworksecurityV1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Network Security API V1beta1"
  gem.description =
      "This is the simple REST client for Network Security API V1beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-networksecurity_v1beta1/v#{Google::Apis::NetworksecurityV1beta1::GEM_VERSION}",
