...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for sqladmin API (prod) V1beta4"
  gem.description =
      "This is the simple REST client for sqladmin API (prod) V1beta4." \
      ...
      " this client to access the sqladmin API (prod), but note that some" \
