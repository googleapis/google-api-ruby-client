...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::SqladminV1beta4::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud SQL Admin API V1beta4"
  gem.description =
      "This is the legacy REST client for Cloud SQL Admin API V1beta4." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-sqladmin_v1beta4/v#{Google::Apis::SqladminV1beta4::GEM_VERSION}",
