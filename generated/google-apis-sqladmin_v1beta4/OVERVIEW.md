# Simple REST client for version V1beta4 of the sqladmin API (prod)

This is a simple client library for version V1beta4 of the sqladmin API (prod). It provides:
...
For reference information on specific calls in the sqladmin API (prod), see the {Google::Apis::SqladminV1beta4::SQLAdminService class reference docs}.
