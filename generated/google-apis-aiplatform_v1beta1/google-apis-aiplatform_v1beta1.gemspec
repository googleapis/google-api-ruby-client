...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Vertex AI API V1beta1"
  gem.description =
      "This is the simple REST client for Vertex AI API V1beta1." \
      ...
      " this client to access the Vertex AI API, but note that some" \
