require File.expand_path("lib/google/apis/cloudbuild_v1alpha2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudbuild_v1alpha2"
  gem.version = Google::Apis::CloudbuildV1alpha2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Build API V1alpha2"
  gem.description =
      "This is the simple REST client for Cloud Build API V1alpha2." \
      ...
      " this client to access the Cloud Build API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudbuild_v1alpha2/v#{Google::Apis::CloudbuildV1alpha2::GEM_VERSION}",
