require File.expand_path("lib/google/apis/realtimebidding_v1alpha/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-realtimebidding_v1alpha"
  gem.version = Google::Apis::RealtimebiddingV1alpha::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Real-time Bidding API V1alpha"
  gem.description =
      "This is the simple REST client for Real-time Bidding API V1alpha." \
      ...
      " this client to access the Real-time Bidding API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-realtimebidding_v1alpha/v#{Google::Apis::RealtimebiddingV1alpha::GEM_VERSION}",
