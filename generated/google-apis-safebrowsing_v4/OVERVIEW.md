# Legacy REST client for version V4 of the Safe Browsing API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Safebrowsing service in particular.)
