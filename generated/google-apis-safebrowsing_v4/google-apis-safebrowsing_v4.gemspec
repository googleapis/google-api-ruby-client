...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::SafebrowsingV4::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Safe Browsing API V4"
  gem.description =
      "This is the legacy REST client for Safe Browsing API V4." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-safebrowsing_v4/v#{Google::Apis::SafebrowsingV4::GEM_VERSION}",
