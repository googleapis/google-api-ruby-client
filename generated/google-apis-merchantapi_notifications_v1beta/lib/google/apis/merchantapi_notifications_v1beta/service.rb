  ...
  module Apis
    module MerchantapiNotificationsV1beta
      ...
      class MerchantService < Google::Apis::Core::BaseService
        ...
        # specific subaccount. See [Decode notifications](/merchant/api/guides/accounts/
        # notifications#decode_notifications) for information on how to decode the
        # notification payload and how to interpret its contents. We will allow the
