...
```ruby
gem 'google-apis-analyticsdata_v1alpha', '~> 0.1'
```
...
```
$ gem install google-apis-analyticsdata_v1alpha
```
...
client = Google::Apis::AnalyticsdataV1alpha::AnalyticsDataService.new
