# Legacy REST client for version V1beta1 of the Database Migration API

This is a simple client library for version V1beta1 of the Database Migration API. It provides:
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/datamigration.googleapis.com) in the console.
...
```ruby
gem 'google-apis-datamigration_v1beta1', '~> 0.1'
```
...
```
$ gem install google-apis-datamigration_v1beta1
```
...
client = Google::Apis::DatamigrationV1beta1::CloudDatabaseMigrationServiceService.new
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Datamigration service in particular.)

For reference information on specific calls in the Database Migration API, see the {Google::Apis::DatamigrationV1beta1::CloudDatabaseMigrationServiceService class reference docs}.
...
The [product documentation](https://cloud.google.com/datamigration/) may provide guidance regarding the preferred client library to use.
