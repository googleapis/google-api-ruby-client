# Simple REST client for version V1beta1 of the Binary Authorization API

This is a simple client library for version V1beta1 of the Binary Authorization API. It provides:
...
```ruby
gem 'google-apis-binaryauthorization_v1beta1', '~> 0.1'
```
...
```
$ gem install google-apis-binaryauthorization_v1beta1
```
...
For reference information on specific calls in the Binary Authorization API, see the {Google::Apis::BinaryauthorizationV1beta1::BinaryAuthorizationService class reference docs}.
