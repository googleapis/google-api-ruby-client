require File.expand_path("lib/google/apis/iam_v2/gem_version", __dir__)
gem_version = Google::Apis::IamV2::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-iam_v2"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Identity and Access Management (IAM) API V2"
  gem.description =
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-iam_v2/v#{gem_version}",
