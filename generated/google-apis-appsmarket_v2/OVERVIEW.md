# Legacy REST client for version V2 of the G Suite Marketplace API
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/appsmarket.googleapis.com) in the console.
...
```ruby
gem 'google-apis-appsmarket_v2', '~> 0.1'
```
...
```
$ gem install google-apis-appsmarket_v2
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Appsmarket service in particular.)

For reference information on specific calls in the G Suite Marketplace API, see the {Google::Apis::AppsmarketV2::GSuiteMarketplaceAPIService class reference docs}.
