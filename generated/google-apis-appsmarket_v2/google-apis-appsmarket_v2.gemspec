...
gem_version = Google::Apis::AppsmarketV2::GEM_VERSION
...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Google Workspace Marketplace API V2"
  gem.description =
      "This is the simple REST client for Google Workspace Marketplace API V2." \
      ...
      " this client to access the Google Workspace Marketplace API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-appsmarket_v2/v#{gem_version}",
