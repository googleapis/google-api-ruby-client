  ...
  module Apis
    module MerchantapiInventoriesV1beta
      ...
      class MerchantService < Google::Apis::Core::BaseService
        ...
        #   for `store_code` "store123", the ``product`` segment must be the unpadded
        #   base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full
        #   resource name for the local inventory would be `accounts/123/products/ZW5-VVN-
        #   c2t1LzEyMw/localInventories/store123`. 2. **Plain Format**: The ``product``
        ...
        #   unpadded base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The
        #   full resource name for the product would be `accounts/123/products/ZW5-VVN-
        #   c2t1LzEyMw`. 2. **Plain Format**: The ``product`` segment is the tilde-
        ...
        #   Example: To represent the product ID `en~US~sku/123`, the ``product`` segment
        #   must be the unpadded base64url encoding of this string, which is `ZW5-VVN-
        #   c2t1LzEyMw`. The full resource name for the product would be `accounts/123/
        #   products/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The ``product`` segment is
