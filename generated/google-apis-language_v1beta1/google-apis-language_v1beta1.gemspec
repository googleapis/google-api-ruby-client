...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::LanguageV1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Natural Language API V1beta1"
  gem.description =
      "This is the legacy REST client for Cloud Natural Language API V1beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-language_v1beta1/v#{Google::Apis::LanguageV1beta1::GEM_VERSION}",
