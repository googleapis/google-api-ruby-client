# Legacy REST client for version V1configuration of the Google Play Game Services Publishing API
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/gamesconfiguration.googleapis.com) in the console.
...
```ruby
gem 'google-apis-games_configuration_v1configuration', '~> 0.1'
```
...
```
$ gem install google-apis-games_configuration_v1configuration
```
...
client = Google::Apis::GamesConfigurationV1configuration::GamesConfigurationService.new
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the GamesConfiguration service in particular.)
