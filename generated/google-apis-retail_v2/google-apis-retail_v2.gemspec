...
gem_version = Google::Apis::RetailV2::GEM_VERSION
...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for AI Commerce Search API V2"
  gem.description =
      "This is the simple REST client for AI Commerce Search API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-retail_v2/v#{gem_version}",
