  ...
  module Apis
    module ClouderrorreportingV1beta1
      ...
      class ReportedErrorEvent
        ...
        # JavaScript, Ruby, C#, PHP, Go, and Rust. Supported stack trace formats are: * *
        ...
        # 29). * **Python**: Must be the return value of [`traceback.format_exc()`](
        # https://docs.python.org/2/library/traceback.html#traceback.format_exc). * **
        # JavaScript**: Must be the value of [`error.stack`](https://github.com/v8/v8/
        # wiki/Stack-Trace-API) as returned by V8. * **Ruby**: Must contain frames
        # returned by [`Exception.backtrace`](https://ruby-doc.org/core-2.2.0/Exception.
        # html#method-i-backtrace). * **C#**: Must be the return value of [`Exception.
        # ToString()`](https://msdn.microsoft.com/en-us/library/system.exception.
        # tostring.aspx). * **PHP**: Must be prefixed with `"PHP (Notice|Parse error|
        # Fatal error|Warning): "` and contain the result of [`(string)$exception`](
        ...
        # Rust**: Must contain standard [`std::backtrace`](https://doc.rust-lang.org/std/
        # backtrace/index.html) frames. Requires `RUST_BACKTRACE=1` and debug symbols
        # enabled.
        # Corresponds to the JSON property `message`
        # @return [String]
        attr_accessor :message
