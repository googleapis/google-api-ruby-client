...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::ClouderrorreportingV1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Error Reporting API V1beta1"
  gem.description =
      "This is the legacy REST client for Error Reporting API V1beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-clouderrorreporting_v1beta1/v#{Google::Apis::ClouderrorreportingV1beta1::GEM_VERSION}",
