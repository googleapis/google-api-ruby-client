# Legacy REST client for version V1 of the Knowledge Graph Search API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Kgsearch service in particular.)
