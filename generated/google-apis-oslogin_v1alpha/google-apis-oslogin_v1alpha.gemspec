...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::OsloginV1alpha::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud OS Login API V1alpha"
  gem.description =
      "This is the legacy REST client for Cloud OS Login API V1alpha." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-oslogin_v1alpha/v#{Google::Apis::OsloginV1alpha::GEM_VERSION}",
