# Legacy REST client for version V1beta1 of the Service Usage API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Serviceusage service in particular.)
