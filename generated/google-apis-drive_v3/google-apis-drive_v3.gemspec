...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DriveV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Drive API V3"
  gem.description =
      "This is the legacy REST client for Drive API V3." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-drive_v3/v#{Google::Apis::DriveV3::GEM_VERSION}",
