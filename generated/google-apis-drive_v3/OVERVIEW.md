# Legacy REST client for version V3 of the Drive API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Drive service in particular.)
