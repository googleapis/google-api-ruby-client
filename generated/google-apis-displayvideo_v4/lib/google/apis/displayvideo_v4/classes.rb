  ...
  module Apis
    module DisplayvideoV4
      ...
      class AdGroup
        ...
        # @return [Google::Apis::DisplayvideoV4::AdGroupInventoryControl]
        attr_accessor :ad_group_inventory_control
        ...
        # @return [Google::Apis::DisplayvideoV4::ProductFeedData]
        ...
        # @return [Google::Apis::DisplayvideoV4::TargetingExpansionConfig]
        ...
        def update!(**args)
          ...
          @ad_group_inventory_control = args[:ad_group_inventory_control] if args.key?(:ad_group_inventory_control)
      ...
      class AdGroupAd
        ...
        # @return [Google::Apis::DisplayvideoV4::AudioAd]
        ...
        attr_accessor :demand_gen_carousel_ad
      
        # Details for a Demand Gen image ad.
        # Corresponds to the JSON property `demandGenImageAd`
        # @return [Google::Apis::DisplayvideoV4::DemandGenImageAd]
        attr_accessor :demand_gen_image_ad
      
        # Details for a Demand Gen product ad.
        # Corresponds to the JSON property `demandGenProductAd`
        # @return [Google::Apis::DisplayvideoV4::DemandGenProductAd]
        attr_accessor :demand_gen_product_ad
      
        # Details for a Demand Gen video ad.
        # Corresponds to the JSON property `demandGenVideoAd`
        # @return [Google::Apis::DisplayvideoV4::DemandGenVideoAd]
        attr_accessor :demand_gen_video_ad
        ...
        # @return [Google::Apis::DisplayvideoV4::InStreamAd]
        ...
        def update!(**args)
          ...
          @demand_gen_video_ad = args[:demand_gen_video_ad] if args.key?(:demand_gen_video_ad)
          @display_name = args[:display_name] if args.key?(:display_name)
      ...
      class AdGroupInventoryControl
        ...
        # @return [String]
        attr_accessor :ad_group_inventory_strategy
      
        # The inventory control of the ad group.
        # Corresponds to the JSON property `selectedInventories`
        # @return [Google::Apis::DisplayvideoV4::SelectedInventories]
      ...
      class Advertiser
        ...
        # @return [Google::Apis::DisplayvideoV4::AdvertiserAdServerConfig]
        ...
        # @return [Google::Apis::DisplayvideoV4::AdvertiserGeneralConfig]
        attr_accessor :general_config
      
        # Integration details of an entry.
        # Corresponds to the JSON property `integrationDetails`
        # @return [Google::Apis::DisplayvideoV4::IntegrationDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AdvertiserTargetingConfig]
      ...
      class AdvertiserAdServerConfig
        ...
        # @return [Google::Apis::DisplayvideoV4::CmHybridConfig]
        attr_accessor :cm_hybrid_config
      
        # Settings for advertisers that use third-party ad servers only.
        # Corresponds to the JSON property `thirdPartyOnlyConfig`
        # @return [Google::Apis::DisplayvideoV4::ThirdPartyOnlyConfig]
      ...
      class AdvertiserDataAccessConfig
        ...
        # @return [Google::Apis::DisplayvideoV4::AdvertiserSdfConfig]
      ...
      class AdvertiserSdfConfig
        ...
        # Corresponds to the JSON property `sdfConfig`
        # @return [Google::Apis::DisplayvideoV4::SdfConfig]
        attr_accessor :sdf_config
      ...
      class AlgorithmRulesComparisonValue
        ...
        # @return [Google::Apis::DisplayvideoV4::DayAndTime]
      ...
      class AlgorithmRulesRule
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AlgorithmRulesRuleCondition>]
        attr_accessor :conditions
      
        # Adjusted value of the signal used for rule evaluation.
        # Corresponds to the JSON property `defaultReturnValue`
        # @return [Google::Apis::DisplayvideoV4::AlgorithmRulesSignalValue]
      ...
      class AlgorithmRulesRuleCondition
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AlgorithmRulesSignalComparison>]
      ...
      class AlgorithmRulesRuleset
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AlgorithmRulesRule>]
        attr_accessor :rules
      ...
      class AlgorithmRulesSignalComparison
        ...
        # @return [Google::Apis::DisplayvideoV4::AlgorithmRulesComparisonValue]
        attr_accessor :comparison_value
      
        # Signal used to evaluate rules.
        # Corresponds to the JSON property `signal`
        # @return [Google::Apis::DisplayvideoV4::AlgorithmRulesSignal]
      ...
      class AssetAssociation
        ...
        # @return [Google::Apis::DisplayvideoV4::Asset]
        attr_accessor :asset
      ...
      class AssignedTargetingOption
        ...
        # @return [Google::Apis::DisplayvideoV4::AgeRangeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AppCategoryAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AppAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AudienceGroupAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AudioContentTypeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::AuthorizedSellerStatusAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::BrowserAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::BusinessChainAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::CarrierAndIspAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::CategoryAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ChannelAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ContentDurationAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ContentGenreAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ContentInstreamPositionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ContentOutstreamPositionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::DayAndTimeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::DeviceMakeModelAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::DeviceTypeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::DigitalContentLabelAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::EnvironmentAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ExchangeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::GenderAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::GeoRegionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::HouseholdIncomeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceGroupAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::KeywordAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::LanguageAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::NativeContentPositionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::NegativeKeywordListAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::OmidAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::OnScreenPositionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::OperatingSystemAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ParentalStatusAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::PoiAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ProximityLocationListAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::RegionalLocationListAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::SensitiveCategoryAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::SessionPositionAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::SubExchangeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ThirdPartyVerifierAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::UrlAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::UserRewardedContentAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::VideoPlayerSizeAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::ViewabilityAssignedTargetingOptionDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::YoutubeVideoAssignedTargetingOptionDetails]
      ...
      class AudienceGroupAssignedTargetingOptionDetails
        ...
        # @return [Google::Apis::DisplayvideoV4::FirstPartyAndPartnerAudienceGroup]
        attr_accessor :excluded_first_party_and_partner_audience_group
        ...
        # @return [Google::Apis::DisplayvideoV4::GoogleAudienceGroup]
        ...
        # @return [Google::Apis::DisplayvideoV4::CombinedAudienceGroup]
        ...
        # @return [Google::Apis::DisplayvideoV4::CustomListGroup]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::FirstPartyAndPartnerAudienceGroup>]
        attr_accessor :included_first_party_and_partner_audience_groups
      ...
      class AudioAd
        ...
        # @return [Google::Apis::DisplayvideoV4::YoutubeVideoDetails]
        attr_accessor :video
      ...
      class BiddingStrategy
        ...
        # @return [Google::Apis::DisplayvideoV4::DemandGenBiddingStrategy]
        attr_accessor :demand_gen_bid
      
        # A strategy that uses a fixed bidding price.
        # Corresponds to the JSON property `fixedBid`
        # @return [Google::Apis::DisplayvideoV4::FixedBidStrategy]
        ...
        # @return [Google::Apis::DisplayvideoV4::MaximizeSpendBidStrategy]
        ...
        # @return [Google::Apis::DisplayvideoV4::PerformanceGoalBidStrategy]
        attr_accessor :performance_goal_auto_bid
      
        # Settings that control the bid strategy for YouTube and Partners resources.
        # Corresponds to the JSON property `youtubeAndPartnersBid`
        # @return [Google::Apis::DisplayvideoV4::YoutubeAndPartnersBiddingStrategy]
      ...
      class BudgetSummary
        ...
        # @return [Google::Apis::DisplayvideoV4::PrismaCpeCode]
      ...
      class BulkEditAdGroupAssignedTargetingOptionsResponse
        ...
        def update!(**args)
          ...
          @failed_ad_group_ids = args[:failed_ad_group_ids] if args.key?(:failed_ad_group_ids)
          @updated_ad_group_ids = args[:updated_ad_group_ids] if args.key?(:updated_ad_group_ids)
        end
      end
      ...
      class BulkEditAssignedInventorySourcesRequest
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AssignedInventorySource>]
      ...
      class BulkEditAssignedLocationsRequest
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AssignedLocation>]
      ...
      class BulkEditAssignedUserRolesRequest
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AssignedUserRole>]
      ...
      class BulkEditNegativeKeywordsRequest
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::NegativeKeyword>]
      ...
      class BulkEditSitesRequest
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Site>]
      ...
      class BulkListAdGroupAssignedTargetingOptionsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AdGroupAssignedTargetingOption>]
      ...
      class BulkListAssignedTargetingOptionsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::LineItemAssignedTargetingOption>]
      ...
      class CampaignBudget
        ...
        # @return [Google::Apis::DisplayvideoV4::PrismaConfig]
      ...
      class CampaignGoal
        ...
        # @return [Google::Apis::DisplayvideoV4::PerformanceGoal]
      ...
      class CarouselCard
        ...
        # @return [String]
        attr_accessor :final_mobile_url
      ...
      class CombinedAudienceGroup
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CombinedAudienceTargetingSetting>]
      ...
      class CreateSdfDownloadTaskRequest
        ...
        # @return [Google::Apis::DisplayvideoV4::IdFilter]
        attr_accessor :id_filter
      
        # A filtering option for filtering on Inventory Source entities.
        # Corresponds to the JSON property `inventorySourceFilter`
        # @return [Google::Apis::DisplayvideoV4::InventorySourceFilter]
        ...
        # @return [Google::Apis::DisplayvideoV4::ParentEntityFilter]
      ...
      class Creative
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Dimensions>]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AssetAssociation>]
        ...
        # @return [Google::Apis::DisplayvideoV4::CmTrackingAd]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CounterEvent>]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::ExitEvent>]
        ...
        # @return [Google::Apis::DisplayvideoV4::ObaIcon]
        ...
        # @return [Google::Apis::DisplayvideoV4::AudioVideoOffset]
        ...
        # @return [Google::Apis::DisplayvideoV4::ReviewStatusInfo]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::ThirdPartyUrl>]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::TimerEvent>]
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Transcode>]
        ...
        # @return [Google::Apis::DisplayvideoV4::UniversalAdId]
      ...
      class CreativeConfig
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceDisplayCreativeConfig]
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceVideoCreativeConfig]
      ...
      class CustomBiddingAlgorithm
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CustomBiddingModelDetails>]
      ...
      class CustomBiddingAlgorithmRules
        ...
        # @return [Google::Apis::DisplayvideoV4::CustomBiddingAlgorithmRulesError]
        attr_accessor :error
        ...
        # Corresponds to the JSON property `rules`
        # @return [Google::Apis::DisplayvideoV4::CustomBiddingAlgorithmRulesRef]
        attr_accessor :rules
      ...
      class CustomBiddingScript
        ...
        # Corresponds to the JSON property `errors`
        # @return [Array<Google::Apis::DisplayvideoV4::ScriptError>]
        attr_accessor :errors
        ...
        # @return [Google::Apis::DisplayvideoV4::CustomBiddingScriptRef]
      ...
      class CustomListGroup
        ...
        # Corresponds to the JSON property `settings`
        # @return [Array<Google::Apis::DisplayvideoV4::CustomListTargetingSetting>]
        attr_accessor :settings
      ...
      class DateRange
        ...
        # @return [Google::Apis::DisplayvideoV4::Date]
      ...
      class DemandGenCarouselAd
        ...
        # @return [String]
        attr_accessor :user_specified_tracking_url
      ...
      class DemandGenProductAd
        ...
        # * `AUTOMATED` * `APPLY_NOW` * `BOOK_NOW` * `CONTACT_US` * `DOWNLOAD` * `
      ...
      class DemandGenVideoAd
        ...
        # Required. The call-to-action button shown on the ad. The supported values are:
        # * `AUTOMATED` * `LEARN_MORE` * `GET_QUOTE` * `APPLY_NOW` * `SIGN_UP` * `
        # CONTACT_US` * `SUBSCRIBE` * `DOWNLOAD` * `BOOK_NOW` * `SHOP_NOW` * `BUY_NOW` *
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::YoutubeVideoDetails>]
      ...
      class DoubleVerify
        ...
        # @return [Google::Apis::DisplayvideoV4::DoubleVerifyAppStarRating]
        ...
        # @return [Google::Apis::DisplayvideoV4::DoubleVerifyBrandSafetyCategories]
        ...
        # @return [Google::Apis::DisplayvideoV4::DoubleVerifyDisplayViewability]
        attr_accessor :display_viewability
      
        # DoubleVerify Fraud & Invalid Traffic settings.
        # Corresponds to the JSON property `fraudInvalidTraffic`
        # @return [Google::Apis::DisplayvideoV4::DoubleVerifyFraudInvalidTraffic]
        attr_accessor :fraud_invalid_traffic
      
        # Details of DoubleVerify video viewability settings.
        # Corresponds to the JSON property `videoViewability`
        # @return [Google::Apis::DisplayvideoV4::DoubleVerifyVideoViewability]
      ...
      class EditCustomerMatchMembersRequest
        ...
        # @return [Google::Apis::DisplayvideoV4::MobileDeviceIdList]
      ...
      class EditCustomerMatchMembersResponse
        ...
        # @return [Fixnum]
        attr_accessor :first_party_and_partner_audience_id
      ...
      class EditInventorySourceReadWriteAccessorsRequest
        ...
        # @return [Google::Apis::DisplayvideoV4::EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate]
      ...
      class ExchangeConfig
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::ExchangeConfigEnabledExchange>]
      ...
      # audiences are created via usage of client data. Partner audiences are provided
      # by Third Party data providers and can only be licensed to customers.
      class FirstPartyAndPartnerAudience
        ...
        # @return [String]
        attr_accessor :first_party_and_partner_audience_type
      ...
      class FirstPartyAndPartnerAudienceGroup
        ...
        # allowed.
        # Corresponds to the JSON property `settings`
        # @return [Array<Google::Apis::DisplayvideoV4::FirstPartyAndPartnerAudienceTargetingSetting>]
        attr_accessor :settings
      ...
      class FloodlightActivity
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::RemarketingConfig>]
      ...
      class FloodlightGroup
        ...
        # @return [Google::Apis::DisplayvideoV4::ActiveViewVideoViewabilityMetricConfig]
        ...
        # @return [Google::Apis::DisplayvideoV4::LookbackWindow]
      ...
      class GoogleAudienceGroup
        ...
        # Corresponds to the JSON property `settings`
        # @return [Array<Google::Apis::DisplayvideoV4::GoogleAudienceTargetingSetting>]
        attr_accessor :settings
      ...
      class GuaranteedOrder
        ...
        # Corresponds to the JSON property `status`
        # @return [Google::Apis::DisplayvideoV4::GuaranteedOrderStatus]
        attr_accessor :status
      ...
      class InsertionOrder
        ...
        # @return [Google::Apis::DisplayvideoV4::InsertionOrderBudget]
        ...
        # @return [Google::Apis::DisplayvideoV4::Kpi]
        attr_accessor :kpi
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::PartnerCost>]
      ...
      class InsertionOrderBudget
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::InsertionOrderBudgetSegment>]
      ...
      class InventorySource
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CreativeConfig>]
        ...
        # @return [Google::Apis::DisplayvideoV4::RateDetails]
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceAccessors]
        attr_accessor :read_write_accessors
      
        # The status related settings of the inventory source.
        # Corresponds to the JSON property `status`
        # @return [Google::Apis::DisplayvideoV4::InventorySourceStatus]
        attr_accessor :status
      
        # A time range.
        # Corresponds to the JSON property `timeRange`
        # @return [Google::Apis::DisplayvideoV4::TimeRange]
      ...
      class InventorySourceAccessors
        ...
        # @return [Google::Apis::DisplayvideoV4::InventorySourceAccessorsAdvertiserAccessors]
        attr_accessor :advertisers
      
        # The partner with access to the inventory source.
        # Corresponds to the JSON property `partner`
        # @return [Google::Apis::DisplayvideoV4::InventorySourceAccessorsPartnerAccessor]
      ...
      class Invoice
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::BudgetSummary>]
      ...
      class LineItem
        ...
        # Corresponds to the JSON property `budget`
        # @return [Google::Apis::DisplayvideoV4::LineItemBudget]
        attr_accessor :budget
        ...
        # counting.
        # Corresponds to the JSON property `conversionCounting`
        # @return [Google::Apis::DisplayvideoV4::ConversionCountingConfig]
        attr_accessor :conversion_counting
        ...
        # @return [Google::Apis::DisplayvideoV4::DemandGenSettings]
        ...
        # @return [Google::Apis::DisplayvideoV4::LineItemFlight]
        ...
        # @return [Google::Apis::DisplayvideoV4::MobileApp]
        ...
        # @return [Google::Apis::DisplayvideoV4::PartnerRevenueModel]
        ...
        # @return [Google::Apis::DisplayvideoV4::YoutubeAndPartnersSettings]
      ...
      class ListAdGroupsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::AdGroup>]
      ...
      class ListAdvertisersResponse
        ...
        # Corresponds to the JSON property `advertisers`
        # @return [Array<Google::Apis::DisplayvideoV4::Advertiser>]
        attr_accessor :advertisers
      ...
      class ListCampaignsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Campaign>]
      ...
      class ListChannelsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Channel>]
      ...
      class ListCombinedAudiencesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CombinedAudience>]
      ...
      class ListCreativesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Creative>]
      ...
      class ListCustomBiddingAlgorithmRulesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CustomBiddingAlgorithmRules>]
      ...
      class ListCustomBiddingAlgorithmsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CustomBiddingAlgorithm>]
      ...
      class ListCustomBiddingScriptsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CustomBiddingScript>]
      ...
      class ListCustomListsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::CustomList>]
      ...
      class ListFirstPartyAndPartnerAudiencesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::FirstPartyAndPartnerAudience>]
        attr_accessor :first_party_and_partner_audiences
      ...
      class ListFloodlightActivitiesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::FloodlightActivity>]
      ...
      class ListGoogleAudiencesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::GoogleAudience>]
      ...
      class ListGuaranteedOrdersResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::GuaranteedOrder>]
      ...
      class ListInsertionOrdersResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::InsertionOrder>]
      ...
      class ListInventorySourceGroupsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::InventorySourceGroup>]
      ...
      class ListInventorySourcesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::InventorySource>]
      ...
      class ListInvoicesResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Invoice>]
      ...
      class ListLineItemsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::LineItem>]
      ...
      class ListLocationListsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::LocationList>]
      ...
      class ListNegativeKeywordListsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::NegativeKeywordList>]
      ...
      class ListPartnersResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::Partner>]
      ...
      class ListTargetingOptionsResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::TargetingOption>]
      ...
      class ListUsersResponse
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::User>]
        attr_accessor :users
      ...
      class Partner
        ...
        # Corresponds to the JSON property `adServerConfig`
        # @return [Google::Apis::DisplayvideoV4::PartnerAdServerConfig]
        attr_accessor :ad_server_config
      
        # Billing related settings of a partner.
        # Corresponds to the JSON property `billingConfig`
        # @return [Google::Apis::DisplayvideoV4::PartnerBillingConfig]
        attr_accessor :billing_config
      
        # Settings that control how partner related data may be accessed.
        # Corresponds to the JSON property `dataAccessConfig`
        # @return [Google::Apis::DisplayvideoV4::PartnerDataAccessConfig]
        attr_accessor :data_access_config
        ...
        # @return [Google::Apis::DisplayvideoV4::ExchangeConfig]
        attr_accessor :exchange_config
      
        # General settings of a partner.
        # Corresponds to the JSON property `generalConfig`
        # @return [Google::Apis::DisplayvideoV4::PartnerGeneralConfig]
        attr_accessor :general_config
      ...
      class PartnerAdServerConfig
        ...
        # @return [Google::Apis::DisplayvideoV4::MeasurementConfig]
      ...
      class ProductFeedData
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::ProductMatchDimension>]
      ...
      class ProductMatchDimension
        ...
        # @return [Google::Apis::DisplayvideoV4::CustomLabel]
      ...
      class RateDetails
        ...
        # @return [Google::Apis::DisplayvideoV4::Money]
      ...
      class ReviewStatusInfo
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::ExchangeReviewStatus>]
      ...
      class SearchTargetingOptionsRequest
        ...
        # @return [Google::Apis::DisplayvideoV4::BusinessChainSearchTerms]
        attr_accessor :business_chain_search_terms
      
        # Search terms for geo region targeting options.
        # Corresponds to the JSON property `geoRegionSearchTerms`
        # @return [Google::Apis::DisplayvideoV4::GeoRegionSearchTerms]
        ...
        # @return [Google::Apis::DisplayvideoV4::PoiSearchTerms]
      ...
      class SelectedInventories
        ...
        # @return [Boolean]
        attr_accessor :allow_discover
        alias_method :allow_discover?, :allow_discover
      
        # Whether the ad group is opted-in to Gmail inventory.
        # Corresponds to the JSON property `allowGmail`
        # @return [Boolean]
        attr_accessor :allow_gmail
        alias_method :allow_gmail?, :allow_gmail
        ...
        # @return [Boolean]
        attr_accessor :allow_google_display_network
        alias_method :allow_google_display_network?, :allow_google_display_network
      
        # Whether the ad group is opted-in to YouTube in-feed inventory.
        # Corresponds to the JSON property `allowYoutubeFeed`
        # @return [Boolean]
        attr_accessor :allow_youtube_feed
        alias_method :allow_youtube_feed?, :allow_youtube_feed
        ...
        alias_method :allow_youtube_stream?, :allow_youtube_stream
      ...
      class TargetingOption
        ...
        # age_range_details field when targeting_type is `TARGETING_TYPE_AGE_RANGE`.
        # Corresponds to the JSON property `ageRangeDetails`
        # @return [Google::Apis::DisplayvideoV4::AgeRangeTargetingOptionDetails]
        attr_accessor :age_range_details
        ...
        # .
        # Corresponds to the JSON property `appCategoryDetails`
        # @return [Google::Apis::DisplayvideoV4::AppCategoryTargetingOptionDetails]
        attr_accessor :app_category_details
        ...
        # TARGETING_TYPE_AUDIO_CONTENT_TYPE`.
        # Corresponds to the JSON property `audioContentTypeDetails`
        # @return [Google::Apis::DisplayvideoV4::AudioContentTypeTargetingOptionDetails]
        attr_accessor :audio_content_type_details
        ...
        # TARGETING_TYPE_AUTHORIZED_SELLER_STATUS`.
        # Corresponds to the JSON property `authorizedSellerStatusDetails`
        # @return [Google::Apis::DisplayvideoV4::AuthorizedSellerStatusTargetingOptionDetails]
        attr_accessor :authorized_seller_status_details
      
        # Represents a targetable browser. This will be populated in the browser_details
        # field when targeting_type is `TARGETING_TYPE_BROWSER`.
        # Corresponds to the JSON property `browserDetails`
        # @return [Google::Apis::DisplayvideoV4::BrowserTargetingOptionDetails]
        attr_accessor :browser_details
        ...
        # TARGETING_TYPE_BUSINESS_CHAIN`.
        # Corresponds to the JSON property `businessChainDetails`
        # @return [Google::Apis::DisplayvideoV4::BusinessChainTargetingOptionDetails]
        attr_accessor :business_chain_details
        ...
        # TARGETING_TYPE_CARRIER_AND_ISP`.
        # Corresponds to the JSON property `carrierAndIspDetails`
        # @return [Google::Apis::DisplayvideoV4::CarrierAndIspTargetingOptionDetails]
        attr_accessor :carrier_and_isp_details
        ...
        # TARGETING_TYPE_CATEGORY`.
        # Corresponds to the JSON property `categoryDetails`
        # @return [Google::Apis::DisplayvideoV4::CategoryTargetingOptionDetails]
        attr_accessor :category_details
        ...
        # TARGETING_TYPE_CONTENT_DURATION`.
        # Corresponds to the JSON property `contentDurationDetails`
        # @return [Google::Apis::DisplayvideoV4::ContentDurationTargetingOptionDetails]
        attr_accessor :content_duration_details
        ...
        # TARGETING_TYPE_CONTENT_GENRE`.
        # Corresponds to the JSON property `contentGenreDetails`
        # @return [Google::Apis::DisplayvideoV4::ContentGenreTargetingOptionDetails]
        attr_accessor :content_genre_details
        ...
        # TARGETING_TYPE_CONTENT_INSTREAM_POSITION`.
        # Corresponds to the JSON property `contentInstreamPositionDetails`
        # @return [Google::Apis::DisplayvideoV4::ContentInstreamPositionTargetingOptionDetails]
        attr_accessor :content_instream_position_details
        ...
        # TARGETING_TYPE_CONTENT_OUTSTREAM_POSITION`.
        # Corresponds to the JSON property `contentOutstreamPositionDetails`
        # @return [Google::Apis::DisplayvideoV4::ContentOutstreamPositionTargetingOptionDetails]
        attr_accessor :content_outstream_position_details
        ...
        # TARGETING_TYPE_DEVICE_MAKE_MODEL`.
        # Corresponds to the JSON property `deviceMakeModelDetails`
        # @return [Google::Apis::DisplayvideoV4::DeviceMakeModelTargetingOptionDetails]
        attr_accessor :device_make_model_details
        ...
        # TARGETING_TYPE_DEVICE_TYPE`.
        # Corresponds to the JSON property `deviceTypeDetails`
        # @return [Google::Apis::DisplayvideoV4::DeviceTypeTargetingOptionDetails]
        attr_accessor :device_type_details
        ...
        # @return [Google::Apis::DisplayvideoV4::DigitalContentLabelTargetingOptionDetails]
        ...
        # TARGETING_TYPE_ENVIRONMENT`.
        # Corresponds to the JSON property `environmentDetails`
        # @return [Google::Apis::DisplayvideoV4::EnvironmentTargetingOptionDetails]
        attr_accessor :environment_details
        ...
        # TARGETING_TYPE_EXCHANGE`.
        # Corresponds to the JSON property `exchangeDetails`
        # @return [Google::Apis::DisplayvideoV4::ExchangeTargetingOptionDetails]
        attr_accessor :exchange_details
      
        # Represents a targetable gender. This will be populated in the gender_details
        # field of a TargetingOption when targeting_type is `TARGETING_TYPE_GENDER`.
        # Corresponds to the JSON property `genderDetails`
        # @return [Google::Apis::DisplayvideoV4::GenderTargetingOptionDetails]
        attr_accessor :gender_details
      
        # Represents a targetable geographic region. This will be populated in the
        # geo_region_details field when targeting_type is `TARGETING_TYPE_GEO_REGION`.
        # Corresponds to the JSON property `geoRegionDetails`
        # @return [Google::Apis::DisplayvideoV4::GeoRegionTargetingOptionDetails]
        attr_accessor :geo_region_details
        ...
        # TARGETING_TYPE_HOUSEHOLD_INCOME`.
        # Corresponds to the JSON property `householdIncomeDetails`
        # @return [Google::Apis::DisplayvideoV4::HouseholdIncomeTargetingOptionDetails]
        attr_accessor :household_income_details
      
        # Represents a targetable language. This will be populated in the
        # language_details field when targeting_type is `TARGETING_TYPE_LANGUAGE`.
        # Corresponds to the JSON property `languageDetails`
        # @return [Google::Apis::DisplayvideoV4::LanguageTargetingOptionDetails]
        attr_accessor :language_details
        ...
        # TARGETING_TYPE_NATIVE_CONTENT_POSITION`.
        # Corresponds to the JSON property `nativeContentPositionDetails`
        # @return [Google::Apis::DisplayvideoV4::NativeContentPositionTargetingOptionDetails]
        attr_accessor :native_content_position_details
        ...
        # TARGETING_TYPE_OMID`.
        # Corresponds to the JSON property `omidDetails`
        # @return [Google::Apis::DisplayvideoV4::OmidTargetingOptionDetails]
        attr_accessor :omid_details
        ...
        # targeting_type is `TARGETING_TYPE_ON_SCREEN_POSITION`.
        # Corresponds to the JSON property `onScreenPositionDetails`
        # @return [Google::Apis::DisplayvideoV4::OnScreenPositionTargetingOptionDetails]
        attr_accessor :on_screen_position_details
        ...
        # TARGETING_TYPE_OPERATING_SYSTEM`.
        # Corresponds to the JSON property `operatingSystemDetails`
        # @return [Google::Apis::DisplayvideoV4::OperatingSystemTargetingOptionDetails]
        attr_accessor :operating_system_details
        ...
        # TARGETING_TYPE_PARENTAL_STATUS`.
        # Corresponds to the JSON property `parentalStatusDetails`
        # @return [Google::Apis::DisplayvideoV4::ParentalStatusTargetingOptionDetails]
        attr_accessor :parental_status_details
      
        # Represents a targetable point of interest(POI). This will be populated in the
        # poi_details field when targeting_type is `TARGETING_TYPE_POI`.
        # Corresponds to the JSON property `poiDetails`
        # @return [Google::Apis::DisplayvideoV4::PoiTargetingOptionDetails]
        attr_accessor :poi_details
        ...
        # @return [Google::Apis::DisplayvideoV4::SensitiveCategoryTargetingOptionDetails]
        ...
        # TARGETING_TYPE_SUB_EXCHANGE`.
        # Corresponds to the JSON property `subExchangeDetails`
        # @return [Google::Apis::DisplayvideoV4::SubExchangeTargetingOptionDetails]
        attr_accessor :sub_exchange_details
        ...
        # Corresponds to the JSON property `userRewardedContentDetails`
        # @return [Google::Apis::DisplayvideoV4::UserRewardedContentTargetingOptionDetails]
        attr_accessor :user_rewarded_content_details
        ...
        # Corresponds to the JSON property `videoPlayerSizeDetails`
        # @return [Google::Apis::DisplayvideoV4::VideoPlayerSizeTargetingOptionDetails]
        attr_accessor :video_player_size_details
        ...
        # TARGETING_TYPE_VIEWABILITY`.
        # Corresponds to the JSON property `viewabilityDetails`
        # @return [Google::Apis::DisplayvideoV4::ViewabilityTargetingOptionDetails]
        attr_accessor :viewability_details
      ...
      class ThirdPartyVerifierAssignedTargetingOptionDetails
        ...
        # @return [Google::Apis::DisplayvideoV4::DoubleVerify]
        attr_accessor :double_verify
      
        # Details of Integral Ad Science settings.
        # Corresponds to the JSON property `integralAdScience`
        # @return [Google::Apis::DisplayvideoV4::IntegralAdScience]
      ...
      class VideoAdSequenceSettings
        ...
        # @return [Array<Google::Apis::DisplayvideoV4::VideoAdSequenceStep>]
        attr_accessor :steps
      ...
      class YoutubeAndPartnersSettings
        ...
        # @return [Google::Apis::DisplayvideoV4::YoutubeAndPartnersInventorySourceConfig]
