require File.expand_path("lib/google/apis/storage_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-storage_v1"
  gem.version = Google::Apis::StorageV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Storage JSON API V1"
  gem.description =
      "This is the legacy REST client for Cloud Storage JSON API V1." \
      ...
      " this client to access the Cloud Storage JSON API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-storage_v1/v#{Google::Apis::StorageV1::GEM_VERSION}",
