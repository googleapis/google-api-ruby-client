# Legacy REST client for version V1 of the AI Platform Training & Prediction API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Ml service in particular.)
