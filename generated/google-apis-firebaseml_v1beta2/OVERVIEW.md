# Legacy REST client for version V1beta2 of the Firebase ML API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Firebaseml service in particular.)
