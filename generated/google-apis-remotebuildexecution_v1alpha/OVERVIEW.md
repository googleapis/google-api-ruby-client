# Simple REST client for version V1alpha of the Remote Build Execution API

This is a simple client library for version V1alpha of the Remote Build Execution API. It provides:
...
```ruby
gem 'google-apis-remotebuildexecution_v1alpha', '~> 0.1'
```
...
```
$ gem install google-apis-remotebuildexecution_v1alpha
```
...
client = Google::Apis::RemotebuildexecutionV1alpha::RemoteBuildExecutionService.new
...
For reference information on specific calls in the Remote Build Execution API, see the {Google::Apis::RemotebuildexecutionV1alpha::RemoteBuildExecutionService class reference docs}.
