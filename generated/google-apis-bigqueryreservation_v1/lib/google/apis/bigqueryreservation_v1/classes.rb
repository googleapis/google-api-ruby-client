  ...
  module Apis
    module BigqueryreservationV1
      ...
      class Assignment
        ...
        # by this principal utilize the associated reservation. Otherwise, jobs fall
        # back to using the reservation assigned to the project, folder, or organization,
        # in that order. If no reservation is assigned at any of these levels, on-
        # demand capacity is used. The supported formats are: * `principal://goog/
        # subject/USER_EMAIL_ADDRESS` for users, * `principal://iam.googleapis.com/
        # projects/-/serviceAccounts/SA_EMAIL_ADDRESS` for service accounts, * `
        # principal://iam.googleapis.com/projects/PROJECT_NUMBER/locations/global/
        # workloadIdentityPools/POOL_ID/subject/SUBJECT_ID` for workload identity pool
