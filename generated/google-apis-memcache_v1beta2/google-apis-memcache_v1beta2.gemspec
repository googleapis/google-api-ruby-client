...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::MemcacheV1beta2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Memorystore for Memcached API V1beta2"
  gem.description =
      "This is the legacy REST client for Cloud Memorystore for Memcached API V1beta2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-memcache_v1beta2/v#{Google::Apis::MemcacheV1beta2::GEM_VERSION}",
