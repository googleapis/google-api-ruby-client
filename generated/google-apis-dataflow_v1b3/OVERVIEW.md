# Legacy REST client for version V1b3 of the Dataflow API

This is a simple client library for version V1b3 of the Dataflow API. It provides:
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/dataflow.googleapis.com) in the console.
...
```ruby
gem 'google-apis-dataflow_v1b3', '~> 0.1'
```
...
```
$ gem install google-apis-dataflow_v1b3
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Dataflow service in particular.)

For reference information on specific calls in the Dataflow API, see the {Google::Apis::DataflowV1b3::DataflowService class reference docs}.
...
The [product documentation](https://cloud.google.com/dataflow) may provide guidance regarding the preferred client library to use.
