...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DataflowV1b3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Dataflow API V1b3"
  gem.description =
      "This is the legacy REST client for Dataflow API V1b3." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dataflow_v1b3/v#{Google::Apis::DataflowV1b3::GEM_VERSION}",
