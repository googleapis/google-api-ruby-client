  ...
  module Apis
    module GkehubV1
      ...
      class GKEHubService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::GkehubV1::RolloutSequence] rollout_sequence_object
        ...
        def create_project_location_rollout_sequence(parent, rollout_sequence_object = nil, rollout_sequence_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/rolloutSequences', options)
          command.request_representation = Google::Apis::GkehubV1::RolloutSequence::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::GkehubV1::RolloutSequence] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::GkehubV1::RolloutSequence]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_rollout_sequence(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::GkehubV1::RolloutSequence::Representation
          command.response_class = Google::Apis::GkehubV1::RolloutSequence
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::GkehubV1::ListRolloutSequencesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::GkehubV1::ListRolloutSequencesResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_rollout_sequences(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/rolloutSequences', options)
          command.response_representation = Google::Apis::GkehubV1::ListRolloutSequencesResponse::Representation
          command.response_class = Google::Apis::GkehubV1::ListRolloutSequencesResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #   locations/`location`/rolloutSequences/`rollout_sequence`
        # @param [Google::Apis::GkehubV1::UpgradeRolloutSequenceRequest] upgrade_rollout_sequence_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def upgrade_rollout_sequence(name, upgrade_rollout_sequence_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::GkehubV1::UpgradeRolloutSequenceRequest::Representation
        ...
        # @param [Google::Apis::GkehubV1::CancelRolloutRequest] cancel_rollout_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def cancel_rollout(name, cancel_rollout_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+name}:cancel', options)
          command.request_representation = Google::Apis::GkehubV1::CancelRolloutRequest::Representation
        ...
        #   location`/rollouts/`rollout`
        # @param [Google::Apis::GkehubV1::ForceCompleteRolloutStageRequest] force_complete_rollout_stage_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def force_project_location_rollout_complete_stage(name, force_complete_rollout_stage_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+name}:forceCompleteStage', options)
          command.request_representation = Google::Apis::GkehubV1::ForceCompleteRolloutStageRequest::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::GkehubV1::Rollout] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::GkehubV1::Rollout]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_rollout(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::GkehubV1::Rollout::Representation
          command.response_class = Google::Apis::GkehubV1::Rollout
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::GkehubV1::ListRolloutsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::GkehubV1::ListRolloutsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_rollouts(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::GkehubV1::ListRolloutsResponse::Representation
          command.response_class = Google::Apis::GkehubV1::ListRolloutsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        #   location`/rollouts/`rollout`
        # @param [Google::Apis::GkehubV1::PauseRolloutRequest] pause_rollout_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def pause_rollout(name, pause_rollout_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::GkehubV1::PauseRolloutRequest::Representation
        ...
        #   location`/rollouts/`rollout`
        # @param [Google::Apis::GkehubV1::ResumeRolloutRequest] resume_rollout_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def resume_rollout(name, resume_rollout_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::GkehubV1::ResumeRolloutRequest::Representation
