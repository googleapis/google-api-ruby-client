...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::JobsV3p1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Talent Solution API V3p1beta1"
  gem.description =
      "This is the legacy REST client for Cloud Talent Solution API V3p1beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-jobs_v3p1beta1/v#{Google::Apis::JobsV3p1beta1::GEM_VERSION}",
