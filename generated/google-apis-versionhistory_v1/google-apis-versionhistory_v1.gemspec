...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::VersionhistoryV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Version History API V1"
  gem.description =
      "This is the simple REST client for Version History API V1." \
      ...
      " this client to access the Version History API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-versionhistory_v1/v#{Google::Apis::VersionhistoryV1::GEM_VERSION}",
