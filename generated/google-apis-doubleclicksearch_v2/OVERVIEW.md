# Legacy REST client for version V2 of the Search Ads 360 API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Doubleclicksearch service in particular.)
