  ...
  module Apis
    module RuntimeconfigV1
      ...
      class CloudRuntimeConfigService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://runtimeconfig.$UNIVERSE_DOMAIN$/"
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-runtimeconfig_v1',
                client_version: Google::Apis::RuntimeconfigV1::GEM_VERSION)
          @batch_path = 'batch'
        end
