...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::RunV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Run Admin API V1"
  gem.description =
      "This is the legacy REST client for Cloud Run Admin API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-run_v1/v#{Google::Apis::RunV1::GEM_VERSION}",
