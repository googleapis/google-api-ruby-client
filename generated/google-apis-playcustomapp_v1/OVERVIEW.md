# Legacy REST client for version V1 of the Google Play Custom App Publishing API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Playcustomapp service in particular.)
