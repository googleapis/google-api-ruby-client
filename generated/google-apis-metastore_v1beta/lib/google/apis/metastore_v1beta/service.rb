  ...
  module Apis
    module MetastoreV1beta
      ...
      class DataprocMetastoreService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::MetastoreV1beta::AlterTablePropertiesRequest] alter_table_properties_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def alter_service_table_properties(service, alter_table_properties_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1beta/{+service}:alterTableProperties', options)
          command.request_representation = Google::Apis::MetastoreV1beta::AlterTablePropertiesRequest::Representation
