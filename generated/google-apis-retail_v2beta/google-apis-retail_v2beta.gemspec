...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::RetailV2beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Retail API V2beta"
  gem.description =
      "This is the simple REST client for Retail API V2beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-retail_v2beta/v#{Google::Apis::RetailV2beta::GEM_VERSION}",
