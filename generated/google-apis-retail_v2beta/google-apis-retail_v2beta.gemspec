...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Vertex AI Search for commerce API V2beta"
  gem.description =
      "This is the simple REST client for Vertex AI Search for commerce API V2beta." \
