# Simple REST client for version V2beta of the AI Commerce Search API

This is a simple client library for version V2beta of the AI Commerce Search API. It provides:
...
For reference information on specific calls in the AI Commerce Search API, see the {Google::Apis::RetailV2beta::CloudRetailService class reference docs}.
