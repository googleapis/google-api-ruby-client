require File.expand_path("lib/google/apis/searchads360_v0/gem_version", __dir__)
gem_version = Google::Apis::Searchads360V0::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-searchads360_v0"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Search Ads 360 Reporting API V0"
  gem.description =
      "This is the simple REST client for Search Ads 360 Reporting API V0." \
      ...
      " this client to access the Search Ads 360 Reporting API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-searchads360_v0/v#{gem_version}",
