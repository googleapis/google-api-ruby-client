require File.expand_path("lib/google/apis/orgpolicy_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-orgpolicy_v2"
  gem.version = Google::Apis::OrgpolicyV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Organization Policy API V2"
  gem.description =
      "This is the simple REST client for Organization Policy API V2." \
      ...
      " this client to access the Organization Policy API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-orgpolicy_v2/v#{Google::Apis::OrgpolicyV2::GEM_VERSION}",
