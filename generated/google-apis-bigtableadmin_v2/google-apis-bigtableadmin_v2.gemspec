require File.expand_path("lib/google/apis/bigtableadmin_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-bigtableadmin_v2"
  gem.version = Google::Apis::BigtableadminV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Bigtable Admin API V2"
  gem.description =
      "This is the simple REST client for Cloud Bigtable Admin API V2." \
      ...
      " this client to access the Cloud Bigtable Admin API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-bigtableadmin_v2/v#{Google::Apis::BigtableadminV2::GEM_VERSION}",
