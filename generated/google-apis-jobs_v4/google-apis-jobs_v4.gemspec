require File.expand_path("lib/google/apis/jobs_v4/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-jobs_v4"
  gem.version = Google::Apis::JobsV4::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Talent Solution API V4"
  gem.description =
      "This is the simple REST client for Cloud Talent Solution API V4." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-jobs_v4/v#{Google::Apis::JobsV4::GEM_VERSION}",
