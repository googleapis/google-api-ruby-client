# Legacy REST client for version V1 of the Compute Engine API

This is a simple client library for version V1 of the Compute Engine API. It provides:
...
```ruby
gem 'google-apis-compute_v1', '~> 0.1'
```
...
For reference information on specific calls in the Compute Engine API, see the {Google::Apis::ComputeV1::ComputeService class reference docs}.
