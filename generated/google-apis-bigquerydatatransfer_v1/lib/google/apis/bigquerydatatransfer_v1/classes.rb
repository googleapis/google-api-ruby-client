  ...
  module Apis
    module BigquerydatatransferV1
      ...
      class TransferConfig
        ...
        # Data source id. Cannot be changed once data transfer is created. The full list
        # of available data source ids can be returned through API call: https://cloud.
        # google.com/bigquery-transfer/docs/reference/datatransfer/rest/v1/projects.
        # locations.dataSources/list The individual data source id can also be found in
        # the bq tab in the 'Setting up a data transfer' section for each data source.
        # For example, the data source id for Cloud Storage transfers is listed here:
