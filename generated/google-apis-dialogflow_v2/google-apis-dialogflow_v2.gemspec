require File.expand_path("lib/google/apis/dialogflow_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-dialogflow_v2"
  gem.version = Google::Apis::DialogflowV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Dialogflow API V2"
  gem.description =
      "This is the simple REST client for Dialogflow API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dialogflow_v2/v#{Google::Apis::DialogflowV2::GEM_VERSION}",
