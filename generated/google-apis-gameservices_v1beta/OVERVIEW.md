# Legacy REST client for version V1beta of the Game Services API

This is a simple client library for version V1beta of the Game Services API. It provides:
...
```ruby
gem 'google-apis-gameservices_v1beta', '~> 0.1'
```
...
```
$ gem install google-apis-gameservices_v1beta
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Gameservices service in particular.)

For reference information on specific calls in the Game Services API, see the {Google::Apis::GameservicesV1beta::GameServicesService class reference docs}.
