# Simple REST client for version V1 of the Security Token Service API

This is a simple client library for version V1 of the Security Token Service API. It provides:
...
```
$ gem install google-apis-sts_v1
```
...
For reference information on specific calls in the Security Token Service API, see the {Google::Apis::StsV1::CloudSecurityTokenService class reference docs}.
