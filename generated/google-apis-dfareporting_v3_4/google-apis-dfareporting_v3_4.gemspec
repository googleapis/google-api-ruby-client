...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DfareportingV3_4::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Campaign Manager 360 API V3_4"
  gem.description =
      "This is the legacy REST client for Campaign Manager 360 API V3_4." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dfareporting_v3_4/v#{Google::Apis::DfareportingV3_4::GEM_VERSION}",
