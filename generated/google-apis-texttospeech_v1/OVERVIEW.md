# Legacy REST client for version V1 of the Cloud Text-to-Speech API

This is a simple client library for version V1 of the Cloud Text-to-Speech API. It provides:
...
```ruby
gem 'google-apis-texttospeech_v1', '~> 0.1'
```
...
```
$ gem install google-apis-texttospeech_v1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Texttospeech service in particular.)

For reference information on specific calls in the Cloud Text-to-Speech API, see the {Google::Apis::TexttospeechV1::TexttospeechService class reference docs}.
