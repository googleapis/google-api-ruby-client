...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::RecommendationengineV1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Recommendations AI V1beta1"
  gem.description =
      "This is the legacy REST client for Recommendations AI V1beta1." \
      ...
      " this client to access the Recommendations AI, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-recommendationengine_v1beta1/v#{Google::Apis::RecommendationengineV1beta1::GEM_VERSION}",
