...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DomainsV1alpha2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Domains API V1alpha2"
  gem.description =
      "This is the legacy REST client for Cloud Domains API V1alpha2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-domains_v1alpha2/v#{Google::Apis::DomainsV1alpha2::GEM_VERSION}",
