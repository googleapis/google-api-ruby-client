require File.expand_path("lib/google/apis/gkeonprem_v1/gem_version", __dir__)
gem_version = Google::Apis::GkeonpremV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-gkeonprem_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Anthos On-Prem API V1"
  gem.description =
      "This is the simple REST client for Anthos On-Prem API V1." \
      ...
      " this client to access the Anthos On-Prem API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-gkeonprem_v1/v#{gem_version}",
