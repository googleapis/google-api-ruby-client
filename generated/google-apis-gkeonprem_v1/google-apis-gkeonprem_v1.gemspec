...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for GDC Virtual API V1"
  gem.description =
      "This is the simple REST client for GDC Virtual API V1." \
      ...
      " this client to access the GDC Virtual API, but note that some" \
