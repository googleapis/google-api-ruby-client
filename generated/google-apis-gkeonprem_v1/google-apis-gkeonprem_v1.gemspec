...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for GKE On-Prem API V1"
  gem.description =
      "This is the simple REST client for GKE On-Prem API V1." \
      ...
      " this client to access the GKE On-Prem API, but note that some" \
