# Legacy REST client for version V1 of the Cloud Bigtable Admin API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Bigtableadmin service in particular.)
