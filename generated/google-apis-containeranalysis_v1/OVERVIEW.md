# Simple REST client for version V1 of the Container Analysis API

This is a simple client library for version V1 of the Container Analysis API. It provides:
...
```ruby
gem 'google-apis-containeranalysis_v1', '~> 0.1'
```
...
```
$ gem install google-apis-containeranalysis_v1
```
...
For reference information on specific calls in the Container Analysis API, see the {Google::Apis::ContaineranalysisV1::ContainerAnalysisService class reference docs}.
