require File.expand_path("lib/google/apis/deploymentmanager_alpha/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-deploymentmanager_alpha"
  gem.version = Google::Apis::DeploymentmanagerAlpha::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Deployment Manager V2 API Alpha"
  gem.description =
      "This is the simple REST client for Cloud Deployment Manager V2 API Alpha." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-deploymentmanager_alpha/v#{Google::Apis::DeploymentmanagerAlpha::GEM_VERSION}",
