...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Google Chat API V1"
  gem.description =
      "This is the simple REST client for Google Chat API V1." \
      ...
      " this client to access the Google Chat API, but note that some" \
