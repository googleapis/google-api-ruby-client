require File.expand_path("lib/google/apis/cloudresourcemanager_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudresourcemanager_v2"
  gem.version = Google::Apis::CloudresourcemanagerV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Resource Manager API V2"
  gem.description =
      "This is the simple REST client for Cloud Resource Manager API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudresourcemanager_v2/v#{Google::Apis::CloudresourcemanagerV2::GEM_VERSION}",
