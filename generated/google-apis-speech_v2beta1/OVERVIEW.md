# Legacy REST client for version V2beta1 of the Cloud Speech-to-Text API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Speech service in particular.)
