...
module Google
  module Apis
    module ContainerV1beta1
      class ClusterRepresentation < Google::Apis::Core::JsonRepresentation; end
      class CreateClusterRequestRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListAggregatedClustersResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListAggregatedOperationsResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListClustersResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListOperationsResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class MasterAuthRepresentation < Google::Apis::Core::JsonRepresentation; end
      class NodeConfigRepresentation < Google::Apis::Core::JsonRepresentation; end
