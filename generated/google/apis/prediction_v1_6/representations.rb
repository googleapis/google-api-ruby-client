...
module Google
  module Apis
    module PredictionV1_6
      class AnalyzeRepresentation < Google::Apis::Core::JsonRepresentation; end
      class InputRepresentation < Google::Apis::Core::JsonRepresentation; end
      class InsertRepresentation < Google::Apis::Core::JsonRepresentation; end
      class Insert2Representation < Google::Apis::Core::JsonRepresentation; end
      ...
      class UpdateRepresentation < Google::Apis::Core::JsonRepresentation; end

      # @private
      class AnalyzeRepresentation < Google::Apis::Core::JsonRepresentation
        property :data_description, as: 'dataDescription', class: Google::Apis::PredictionV1_6::Analyze::DataDescription do
          collection :features, as: 'features', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::Feature do
            property :categorical, as: 'categorical', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::Feature::Categorical do
              property :count, as: 'count'
              collection :values, as: 'values', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::Feature::Categorical::Value do
                property :count, as: 'count'
            ...
            property :numeric, as: 'numeric', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::Feature::Numeric do
              property :count, as: 'count'
              property :mean, as: 'mean'
              property :variance, as: 'variance'
            end
            
            property :text, as: 'text', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::Feature::Text do
              property :count, as: 'count'
            end
          end
          
          
          property :output_feature, as: 'outputFeature', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::OutputFeature do
            property :numeric, as: 'numeric', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::OutputFeature::Numeric do
              property :count, as: 'count'
              property :mean, as: 'mean'
              property :variance, as: 'variance'
            end
            
            collection :text, as: 'text', class: Google::Apis::PredictionV1_6::Analyze::DataDescription::OutputFeature::Text do
              property :count, as: 'count'
              property :value, as: 'value'
            end
          end
        ...
        property :model_description, as: 'modelDescription', class: Google::Apis::PredictionV1_6::Analyze::ModelDescription do
      ...
      class InputRepresentation < Google::Apis::Core::JsonRepresentation
        property :input, as: 'input', class: Google::Apis::PredictionV1_6::Input::Input do
      ...
      class InsertRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        collection :training_instances, as: 'trainingInstances', class: Google::Apis::PredictionV1_6::Insert::TrainingInstance do
          collection :csv_instance, as: 'csvInstance'
      ...
      class Insert2Representation < Google::Apis::Core::JsonRepresentation
        ...
        property :id, as: 'id'
        property :kind, as: 'kind'
        property :model_info, as: 'modelInfo', class: Google::Apis::PredictionV1_6::Insert2::ModelInfo do
      ...
      class OutputRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        collection :output_multi, as: 'outputMulti', class: Google::Apis::PredictionV1_6::Output::OutputMulti do
