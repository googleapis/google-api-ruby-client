...
module Google
  module Apis
    module AutoscalerV1beta2
      class AutoscalerRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AutoscalingPolicyRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AutoscalingPolicyCpuUtilizationRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AutoscalingPolicyCustomMetricUtilizationRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AutoscalingPolicyLoadBalancingUtilizationRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class OperationRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :error, as: 'error', class: Google::Apis::AutoscalerV1beta2::Operation::Error do
          collection :errors, as: 'errors', class: Google::Apis::AutoscalerV1beta2::Operation::Error::Error do
        ...
        collection :warnings, as: 'warnings', class: Google::Apis::AutoscalerV1beta2::Operation::Warning do
          property :code, as: 'code'
          collection :data, as: 'data', class: Google::Apis::AutoscalerV1beta2::Operation::Warning::Datum do
            property :key, as: 'key'
      ...
      class ZoneRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :id, as: 'id'
        property :kind, as: 'kind'
        collection :maintenance_windows, as: 'maintenanceWindows', class: Google::Apis::AutoscalerV1beta2::Zone::MaintenanceWindow do
