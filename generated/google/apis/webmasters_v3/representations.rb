...
module Google
  module Apis
    module WebmastersV3
      class SitemapsListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class SitesListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlCrawlErrorCountRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlCrawlErrorCountsPerTypeRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlCrawlErrorsCountsQueryResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlCrawlErrorsSampleRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlCrawlErrorsSamplesListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UrlSampleDetailsRepresentation < Google::Apis::Core::JsonRepresentation; end
      class WmxSiteRepresentation < Google::Apis::Core::JsonRepresentation; end
      class WmxSitemapRepresentation < Google::Apis::Core::JsonRepresentation; end
      class WmxSitemapContentRepresentation < Google::Apis::Core::JsonRepresentation; end
