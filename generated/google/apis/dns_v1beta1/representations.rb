  ...
  module Apis
    module DnsV1beta1
      ...
      class ChangeRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::Change
        
        collection :additions, as: 'additions', class: Google::Apis::DnsV1beta1::ResourceRecordSet, decorator: Google::Apis::DnsV1beta1::ResourceRecordSetRepresentation
        
        
        collection :deletions, as: 'deletions', class: Google::Apis::DnsV1beta1::ResourceRecordSet, decorator: Google::Apis::DnsV1beta1::ResourceRecordSetRepresentation
      ...
      class ChangesListResponseRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::ChangesListResponse
        
        collection :changes, as: 'changes', class: Google::Apis::DnsV1beta1::Change, decorator: Google::Apis::DnsV1beta1::ChangeRepresentation
      ...
      class ManagedZoneRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::ManagedZone
      ...
      class ManagedZonesListResponseRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::ManagedZonesListResponse
        
        property :kind, as: 'kind'
        collection :managed_zones, as: 'managedZones', class: Google::Apis::DnsV1beta1::ManagedZone, decorator: Google::Apis::DnsV1beta1::ManagedZoneRepresentation
      ...
      class ProjectRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::Project
        
        property :id, as: 'id'
        property :kind, as: 'kind'
        property :number, as: 'number'
        property :quota, as: 'quota', class: Google::Apis::DnsV1beta1::Quota, decorator: Google::Apis::DnsV1beta1::QuotaRepresentation
      end

      # @private
      class QuotaRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::Quota
      ...
      class ResourceRecordSetRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::ResourceRecordSet
      ...
      class ResourceRecordSetsListResponseRepresentation < Google::Apis::Core::JsonRepresentation
        collection_representer class: Google::Apis::DnsV1beta1::ResourceRecordSetsListResponse
        
        property :kind, as: 'kind'
        property :next_page_token, as: 'nextPageToken'
        collection :rrsets, as: 'rrsets', class: Google::Apis::DnsV1beta1::ResourceRecordSet, decorator: Google::Apis::DnsV1beta1::ResourceRecordSetRepresentation
      end
    end
  end
end
