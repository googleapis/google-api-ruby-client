...
module Google
  module Apis
    module MirrorV1
      ...
      class AttachmentsListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AuthTokenRepresentation < Google::Apis::Core::JsonRepresentation; end
      class CommandRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ContactRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ContactsListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LocationRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LocationsListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class MenuItemRepresentation < Google::Apis::Core::JsonRepresentation; end
      class MenuValueRepresentation < Google::Apis::Core::JsonRepresentation; end
      class NotificationRepresentation < Google::Apis::Core::JsonRepresentation; end
      class NotificationConfigRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class SubscriptionsListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class TimelineItemRepresentation < Google::Apis::Core::JsonRepresentation; end
      class TimelineListResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UserActionRepresentation < Google::Apis::Core::JsonRepresentation; end
      class UserDataRepresentation < Google::Apis::Core::JsonRepresentation; end
