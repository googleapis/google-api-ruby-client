  ...
  module Apis
    module MlV1
      ...
      class GoogleCloudMlV1GetConfigResponse
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :service_account_project, as: 'serviceAccountProject'
      ...
      class GoogleCloudMlV1PredictionOutput
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :prediction_count, as: 'predictionCount'
      ...
      class GoogleCloudMlV1TrainingOutput
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :completed_trial_count, as: 'completedTrialCount'
      ...
      class GoogleCloudMlV1HyperparameterOutputHyperparameterMetric
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :training_step, as: 'trainingStep'
      ...
      class GoogleCloudMlV1TrainingInput
        ...
        class Representation < Google::Apis::Core::JsonRepresentation
          ...
          property :parameter_server_count, as: 'parameterServerCount'
