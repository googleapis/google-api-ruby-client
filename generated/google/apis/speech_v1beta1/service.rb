  ...
  module Apis
    module SpeechV1beta1
      ...
      class SpeechService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def syncrecognize_speech(sync_recognize_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def asyncrecognize_speech(async_recognize_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
