  ...
  module Apis
    module BigqueryV2
      ...
      class JobConfigurationLoad
        ...
        # If this is populated, only the specified properties will be imported for each
        # entity. Currently, this is only supported for DATASTORE_BACKUP imports and
        # only top level properties are supported. If any specified property is not
        # found in the Datastore 'Kind' being imported, that is an error. Note: This
