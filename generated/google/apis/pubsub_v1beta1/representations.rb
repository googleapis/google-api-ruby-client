...
module Google
  module Apis
    module PubsubV1beta1
      ...
      class PublishBatchRequestRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PublishBatchResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class PullBatchRequestRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PullBatchResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
