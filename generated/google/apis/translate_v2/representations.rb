    ...
    module TranslateV2
      ...
      class ListResponse
        class Representation < Google::Apis::Core::JsonRepresentation
          self.representation_wrap = lambda { |args| :data if args[:unwrap] == Google::Apis::TranslateV2::ListResponse }
          collection :detections, as: 'detections', :class => Array do
        include Representable::JSON::Collection
        items class: Google::Apis::TranslateV2::Resource, decorator: Google::Apis::TranslateV2::Resource::Representation
      ...
      class Resource
        class Representation < Google::Apis::Core::JsonRepresentation
          self.representation_wrap = lambda { |args| :data if args[:unwrap] == Google::Apis::TranslateV2::Resource }
