...
module Google
  module Apis
    module StorageV1
      class BucketRepresentation < Google::Apis::Core::JsonRepresentation; end
      class BucketAccessControlRepresentation < Google::Apis::Core::JsonRepresentation; end
      class BucketAccessControlsRepresentation < Google::Apis::Core::JsonRepresentation; end
      class BucketsRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChannelRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ComposeRequestRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ObjectRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ObjectAccessControlRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ObjectAccessControlsRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ObjectsRepresentation < Google::Apis::Core::JsonRepresentation; end
      class RewriteResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class BucketRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        collection :cors, as: 'cors', class: Google::Apis::StorageV1::Bucket::Cor do
        ...
        property :lifecycle, as: 'lifecycle', class: Google::Apis::StorageV1::Bucket::Lifecycle do
          collection :rule, as: 'rule', class: Google::Apis::StorageV1::Bucket::Lifecycle::Rule do
            property :action, as: 'action', class: Google::Apis::StorageV1::Bucket::Lifecycle::Rule::Action do
              property :type, as: 'type'
            end
            
            property :condition, as: 'condition', class: Google::Apis::StorageV1::Bucket::Lifecycle::Rule::Condition do
              property :age, as: 'age'
        ...
        property :logging, as: 'logging', class: Google::Apis::StorageV1::Bucket::Logging do
        ...
        property :owner, as: 'owner', class: Google::Apis::StorageV1::Bucket::Owner do
        ...
        property :versioning, as: 'versioning', class: Google::Apis::StorageV1::Bucket::Versioning do
          property :enabled, as: 'enabled'
        end
        
        property :website, as: 'website', class: Google::Apis::StorageV1::Bucket::Website do
      ...
      class BucketAccessControlRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :id, as: 'id'
        property :kind, as: 'kind'
        property :project_team, as: 'projectTeam', class: Google::Apis::StorageV1::BucketAccessControl::ProjectTeam do
          property :project_number, as: 'projectNumber'
      ...
      class ComposeRequestRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :kind, as: 'kind'
        collection :source_objects, as: 'sourceObjects', class: Google::Apis::StorageV1::ComposeRequest::SourceObject do
          property :generation, as: 'generation'
          property :name, as: 'name'
          property :object_preconditions, as: 'objectPreconditions', class: Google::Apis::StorageV1::ComposeRequest::SourceObject::ObjectPreconditions do
      ...
      class ObjectRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :metageneration, as: 'metageneration'
        property :name, as: 'name'
        property :owner, as: 'owner', class: Google::Apis::StorageV1::Object::Owner do
          property :entity, as: 'entity'
          property :entity_id, as: 'entityId'
        end
      ...
      class ObjectAccessControlRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :project_team, as: 'projectTeam', class: Google::Apis::StorageV1::ObjectAccessControl::ProjectTeam do
          property :project_number, as: 'projectNumber'
          property :team, as: 'team'
        end
