  ...
  module Apis
    module DialogflowV3alpha1
      ...
      class GoogleCloudDialogflowV2BatchUpdateEntityTypesResponse
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2EntityType>]
      ...
      class GoogleCloudDialogflowV2BatchUpdateIntentsResponse
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2Intent>]
      ...
      class GoogleCloudDialogflowV2ConversationEvent
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleRpcStatus]
        attr_accessor :error_status
      
        # Represents a message posted into a conversation.
        # Corresponds to the JSON property `newMessagePayload`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2Message]
      ...
      class GoogleCloudDialogflowV2EntityType
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2EntityTypeEntity>]
      ...
      class GoogleCloudDialogflowV2Intent
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentFollowupIntentInfo>]
        ...
        # Corresponds to the JSON property `messages`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessage>]
        attr_accessor :messages
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2Context>]
        attr_accessor :output_contexts
      
        # Optional. The collection of parameters associated with the intent.
        # Corresponds to the JSON property `parameters`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentParameter>]
        attr_accessor :parameters
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentTrainingPhrase>]
      ...
      class GoogleCloudDialogflowV2IntentMessage
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBasicCard]
        attr_accessor :basic_card
      
        # Browse Carousel Card for Actions on Google.
        # https://developers.google.com/actions/assistant/responses#browsing_carousel
        # Corresponds to the JSON property `browseCarouselCard`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard]
        attr_accessor :browse_carousel_card
      
        # The card response message.
        # Corresponds to the JSON property `card`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageCard]
        attr_accessor :card
      
        # The card for presenting a carousel of options to select from.
        # Corresponds to the JSON property `carouselSelect`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageCarouselSelect]
        attr_accessor :carousel_select
      
        # The image response message.
        # Corresponds to the JSON property `image`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageImage]
        attr_accessor :image
      
        # The suggestion chip message that allows the user to jump out to the app
        # or website associated with this agent.
        # Corresponds to the JSON property `linkOutSuggestion`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageLinkOutSuggestion]
        attr_accessor :link_out_suggestion
      
        # The card for presenting a list of options to select from.
        # Corresponds to the JSON property `listSelect`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageListSelect]
        attr_accessor :list_select
      
        # The media content card for Actions on Google.
        # Corresponds to the JSON property `mediaContent`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageMediaContent]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageQuickReplies]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageSimpleResponses]
        attr_accessor :simple_responses
      
        # The collection of suggestions.
        # Corresponds to the JSON property `suggestions`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageSuggestions]
        attr_accessor :suggestions
      
        # Table card for Actions on Google.
        # Corresponds to the JSON property `tableCard`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageTableCard]
        attr_accessor :table_card
      
        # The text response message.
        # Corresponds to the JSON property `text`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageText]
        attr_accessor :text
      ...
      class GoogleCloudDialogflowV2IntentMessageBasicCard
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBasicCardButton>]
      ...
      class GoogleCloudDialogflowV2IntentMessageBasicCardButton
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBasicCardButtonOpenUriAction]
      ...
      class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCard
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItem
        ...
        # Corresponds to the JSON property `openUriAction`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageBrowseCarouselCardBrowseCarouselCardItemOpenUrlAction]
        attr_accessor :open_uri_action
      ...
      class GoogleCloudDialogflowV2IntentMessageCard
        ...
        # Optional. The collection of card buttons.
        # Corresponds to the JSON property `buttons`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageCardButton>]
        attr_accessor :buttons
      ...
      class GoogleCloudDialogflowV2IntentMessageCarouselSelect
        ...
        # Corresponds to the JSON property `items`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageCarouselSelectItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2IntentMessageCarouselSelectItem
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageSelectItemInfo]
        attr_accessor :info
      ...
      class GoogleCloudDialogflowV2IntentMessageListSelect
        ...
        # Required. List items.
        # Corresponds to the JSON property `items`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageListSelectItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2IntentMessageMediaContent
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageMediaContentResponseMediaObject>]
      ...
      class GoogleCloudDialogflowV2IntentMessageSimpleResponses
        ...
        # Corresponds to the JSON property `simpleResponses`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageSimpleResponse>]
        attr_accessor :simple_responses
      ...
      class GoogleCloudDialogflowV2IntentMessageSuggestions
        ...
        # Corresponds to the JSON property `suggestions`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageSuggestion>]
        attr_accessor :suggestions
      ...
      class GoogleCloudDialogflowV2IntentMessageTableCard
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageColumnProperties>]
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageTableCardRow>]
        attr_accessor :rows
      ...
      class GoogleCloudDialogflowV2IntentMessageTableCardRow
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentMessageTableCardCell>]
        attr_accessor :cells
      ...
      class GoogleCloudDialogflowV2IntentTrainingPhrase
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2IntentTrainingPhrasePart>]
        attr_accessor :parts
      ...
      class GoogleCloudDialogflowV2Message
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2MessageAnnotation]
      ...
      class GoogleCloudDialogflowV2MessageAnnotation
        ...
        # Corresponds to the JSON property `parts`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2AnnotatedMessagePart>]
        attr_accessor :parts
      ...
      class GoogleCloudDialogflowV2QueryResult
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2Intent]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2SentimentAnalysisResult]
      ...
      class GoogleCloudDialogflowV2SentimentAnalysisResult
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2Sentiment]
      ...
      class GoogleCloudDialogflowV2WebhookRequest
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2OriginalDetectIntentRequest]
        attr_accessor :original_detect_intent_request
      
        # Represents the result of conversational query or event processing.
        # Corresponds to the JSON property `queryResult`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2QueryResult]
      ...
      class GoogleCloudDialogflowV2WebhookResponse
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2EventInput]
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2SessionEntityType>]
      ...
      class GoogleCloudDialogflowV2beta1BatchUpdateEntityTypesResponse
        ...
        # The collection of updated or created entity types.
        # Corresponds to the JSON property `entityTypes`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1EntityType>]
        attr_accessor :entity_types
      ...
      class GoogleCloudDialogflowV2beta1BatchUpdateIntentsResponse
        ...
        # The collection of updated or created intents.
        # Corresponds to the JSON property `intents`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1Intent>]
        attr_accessor :intents
      ...
      class GoogleCloudDialogflowV2beta1EntityType
        ...
        # Optional. The collection of entity entries associated with the entity type.
        # Corresponds to the JSON property `entities`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1EntityTypeEntity>]
        attr_accessor :entities
      ...
      class GoogleCloudDialogflowV2beta1Intent
        ...
        # a direct or indirect parent. We populate this field only in the output.
        # Corresponds to the JSON property `followupIntentInfo`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo>]
        attr_accessor :followup_intent_info
        ...
        # `Response` field in the Dialogflow console.
        # Corresponds to the JSON property `messages`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessage>]
        attr_accessor :messages
        ...
        # Format: `projects/<Project ID>/agent/sessions/-/contexts/<Context ID>`.
        # Corresponds to the JSON property `outputContexts`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1Context>]
        attr_accessor :output_contexts
      
        # Optional. The collection of parameters associated with the intent.
        # Corresponds to the JSON property `parameters`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentParameter>]
        attr_accessor :parameters
        ...
        # trained on.
        # Corresponds to the JSON property `trainingPhrases`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentTrainingPhrase>]
        attr_accessor :training_phrases
      ...
      class GoogleCloudDialogflowV2beta1IntentMessage
        ...
        # The basic card message. Useful for displaying information.
        # Corresponds to the JSON property `basicCard`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBasicCard]
        attr_accessor :basic_card
      
        # Browse Carousel Card for Actions on Google.
        # https://developers.google.com/actions/assistant/responses#browsing_carousel
        # Corresponds to the JSON property `browseCarouselCard`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard]
        attr_accessor :browse_carousel_card
      
        # The card response message.
        # Corresponds to the JSON property `card`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageCard]
        attr_accessor :card
      
        # The card for presenting a carousel of options to select from.
        # Corresponds to the JSON property `carouselSelect`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect]
        attr_accessor :carousel_select
      
        # The image response message.
        # Corresponds to the JSON property `image`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageImage]
        attr_accessor :image
      
        # The suggestion chip message that allows the user to jump out to the app
        # or website associated with this agent.
        # Corresponds to the JSON property `linkOutSuggestion`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageLinkOutSuggestion]
        attr_accessor :link_out_suggestion
      
        # The card for presenting a list of options to select from.
        # Corresponds to the JSON property `listSelect`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageListSelect]
        attr_accessor :list_select
      
        # The media content card for Actions on Google.
        # Corresponds to the JSON property `mediaContent`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageMediaContent]
        attr_accessor :media_content
        ...
        # The quick replies response message.
        # Corresponds to the JSON property `quickReplies`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageQuickReplies]
        attr_accessor :quick_replies
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard]
        attr_accessor :rbm_standalone_rich_card
      
        # Rich Business Messaging (RBM) text response with suggestions.
        # Corresponds to the JSON property `rbmText`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmText]
        ...
        # `SimpleResponse`.
        # Corresponds to the JSON property `simpleResponses`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses]
        attr_accessor :simple_responses
      
        # The collection of suggestions.
        # Corresponds to the JSON property `suggestions`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageSuggestions]
        attr_accessor :suggestions
      
        # Table card for Actions on Google.
        # Corresponds to the JSON property `tableCard`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTableCard]
        attr_accessor :table_card
      
        # Plays audio from a file in Telephony Gateway.
        # Corresponds to the JSON property `telephonyPlayAudio`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTelephonyPlayAudio]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTelephonySynthesizeSpeech]
        attr_accessor :telephony_synthesize_speech
      
        # Transfers the call in Telephony Gateway.
        # Corresponds to the JSON property `telephonyTransferCall`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTelephonyTransferCall]
        attr_accessor :telephony_transfer_call
      
        # The text response message.
        # Corresponds to the JSON property `text`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageText]
        attr_accessor :text
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageBasicCard
        ...
        # Optional. The collection of card buttons.
        # Corresponds to the JSON property `buttons`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBasicCardButton>]
        attr_accessor :buttons
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageBasicCardButton
        ...
        # Opens the given URI.
        # Corresponds to the JSON property `openUriAction`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBasicCardButtonOpenUriAction]
        attr_accessor :open_uri_action
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCard
        ...
        # items, maximum of ten.
        # Corresponds to the JSON property `items`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItem
        ...
        # Actions on Google action to open a given url.
        # Corresponds to the JSON property `openUriAction`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageBrowseCarouselCardBrowseCarouselCardItemOpenUrlAction]
        attr_accessor :open_uri_action
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageCard
        ...
        # Optional. The collection of card buttons.
        # Corresponds to the JSON property `buttons`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageCardButton>]
        attr_accessor :buttons
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelect
        ...
        # Required. Carousel items.
        # Corresponds to the JSON property `items`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem
        ...
        # dialog.
        # Corresponds to the JSON property `info`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageSelectItemInfo]
        attr_accessor :info
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageListSelect
        ...
        # Required. List items.
        # Corresponds to the JSON property `items`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageListSelectItem>]
        attr_accessor :items
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageMediaContent
        ...
        # Required. List of media objects.
        # Corresponds to the JSON property `mediaObjects`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageMediaContentResponseMediaObject>]
        attr_accessor :media_objects
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia]
        attr_accessor :media
      
        # Optional. List of suggestions to include in the card.
        # Corresponds to the JSON property `suggestions`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestion>]
        attr_accessor :suggestions
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent>]
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageRbmStandaloneCard
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent]
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedAction
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionDial]
        attr_accessor :dial
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionOpenUri]
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedActionRbmSuggestedActionShareLocation]
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestion
        ...
        # can choose from the card.
        # Corresponds to the JSON property `action`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedAction]
        attr_accessor :action
      
        # Rich Business Messaging (RBM) suggested reply that the user can click
        # instead of typing in their own response.
        # Corresponds to the JSON property `reply`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageRbmSuggestedReply]
        attr_accessor :reply
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageSimpleResponses
        ...
        # Required. The list of simple responses.
        # Corresponds to the JSON property `simpleResponses`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse>]
        attr_accessor :simple_responses
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageSuggestions
        ...
        # Required. The list of suggested replies.
        # Corresponds to the JSON property `suggestions`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageSuggestion>]
        attr_accessor :suggestions
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageTableCard
        ...
        # Optional. Display properties for the columns in this table.
        # Corresponds to the JSON property `columnProperties`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageColumnProperties>]
        attr_accessor :column_properties
        ...
        # Optional. Rows in this table of data.
        # Corresponds to the JSON property `rows`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTableCardRow>]
        attr_accessor :rows
      ...
      class GoogleCloudDialogflowV2beta1IntentMessageTableCardRow
        ...
        # Optional. List of cells that make up this row.
        # Corresponds to the JSON property `cells`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentMessageTableCardCell>]
        attr_accessor :cells
      ...
      class GoogleCloudDialogflowV2beta1IntentTrainingPhrase
        ...
        # set.
        # Corresponds to the JSON property `parts`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart>]
        attr_accessor :parts
      ...
      class GoogleCloudDialogflowV2beta1KnowledgeAnswers
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1KnowledgeAnswersAnswer>]
      ...
      class GoogleCloudDialogflowV2beta1LabelConversationResponse
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1AnnotatedConversationDataset]
      ...
      class GoogleCloudDialogflowV2beta1QueryResult
        ...
        # action is an extraction of a user command or sentence semantics.
        # Corresponds to the JSON property `intent`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1Intent]
        attr_accessor :intent
        ...
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1KnowledgeAnswers]
        ...
        # `sentiment_analysis_request_config`.
        # Corresponds to the JSON property `sentimentAnalysisResult`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1SentimentAnalysisResult]
        attr_accessor :sentiment_analysis_result
      ...
      class GoogleCloudDialogflowV2beta1SentimentAnalysisResult
        ...
        # of analysis, such as the query text.
        # Corresponds to the JSON property `queryTextSentiment`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1Sentiment]
        attr_accessor :query_text_sentiment
      ...
      class GoogleCloudDialogflowV2beta1WebhookRequest
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1QueryResult>]
        attr_accessor :alternative_query_results
      
        # Represents the contents of the original request that was passed to
        # the `[Streaming]DetectIntent` call.
        # Corresponds to the JSON property `originalDetectIntentRequest`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest]
        attr_accessor :original_detect_intent_request
      
        # Represents the result of conversational query or event processing.
        # Corresponds to the JSON property `queryResult`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1QueryResult]
        attr_accessor :query_result
      ...
      class GoogleCloudDialogflowV2beta1WebhookResponse
        ...
        # `"Hello #welcome_event.name! What can I do for you today?"`.
        # Corresponds to the JSON property `followupEventInput`
        # @return [Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1EventInput]
        attr_accessor :followup_event_input
        ...
        # `streamingDetectIntent` or SessionEntityType management methods.
        # Corresponds to the JSON property `sessionEntityTypes`
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleCloudDialogflowV2beta1SessionEntityType>]
        attr_accessor :session_entity_types
      ...
      class GoogleLongrunningListOperationsResponse
        ...
        # @return [Array<Google::Apis::DialogflowV3alpha1::GoogleLongrunningOperation>]
