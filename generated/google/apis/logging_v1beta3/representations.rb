...
module Google
  module Apis
    module LoggingV1beta3
      class ListLogsResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogRepresentation < Google::Apis::Core::JsonRepresentation; end
      class EmptyRepresentation < Google::Apis::Core::JsonRepresentation; end
      class WriteLogEntriesRequestRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogEntryRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogEntryMetadataRepresentation < Google::Apis::Core::JsonRepresentation; end
      class WriteLogEntriesResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListLogServicesResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogServiceRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListLogServiceIndexesResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListLogSinksResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogSinkRepresentation < Google::Apis::Core::JsonRepresentation; end
      class LogErrorRepresentation < Google::Apis::Core::JsonRepresentation; end
      class StatusRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ListLogServiceSinksResponseRepresentation < Google::Apis::Core::JsonRepresentation; end
