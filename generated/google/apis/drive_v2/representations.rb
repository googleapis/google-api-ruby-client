...
module Google
  module Apis
    module DriveV2
      class AboutRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AppRepresentation < Google::Apis::Core::JsonRepresentation; end
      class AppListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChangeRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChangeListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChannelRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChildListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ChildReferenceRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class CommentReplyRepresentation < Google::Apis::Core::JsonRepresentation; end
      class CommentReplyListRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class ParentListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class ParentReferenceRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PermissionRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PermissionIdRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PermissionListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PropertyRepresentation < Google::Apis::Core::JsonRepresentation; end
      class PropertyListRepresentation < Google::Apis::Core::JsonRepresentation; end
      class RevisionRepresentation < Google::Apis::Core::JsonRepresentation; end
      class RevisionListRepresentation < Google::Apis::Core::JsonRepresentation; end
      ...
      class AboutRepresentation < Google::Apis::Core::JsonRepresentation
        collection :additional_role_info, as: 'additionalRoleInfo', class: Google::Apis::DriveV2::About::AdditionalRoleInfo do
          collection :role_sets, as: 'roleSets', class: Google::Apis::DriveV2::About::AdditionalRoleInfo::RoleSet do
        ...
        collection :export_formats, as: 'exportFormats', class: Google::Apis::DriveV2::About::ExportFormat do
          property :source, as: 'source'
          collection :targets, as: 'targets'
        end
        
        
        collection :features, as: 'features', class: Google::Apis::DriveV2::About::Feature do
        ...
        collection :import_formats, as: 'importFormats', class: Google::Apis::DriveV2::About::ImportFormat do
          property :source, as: 'source'
          collection :targets, as: 'targets'
        end
        ...
        collection :max_upload_sizes, as: 'maxUploadSizes', class: Google::Apis::DriveV2::About::MaxUploadSize do
        ...
        collection :quota_bytes_by_service, as: 'quotaBytesByService', class: Google::Apis::DriveV2::About::QuotaBytesByService do
      ...
      class AppRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        collection :icons, as: 'icons', class: Google::Apis::DriveV2::App::Icon do
      ...
      class CommentRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :context, as: 'context', class: Google::Apis::DriveV2::Comment::Context do
          property :type, as: 'type'
      ...
      class FileRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :id, as: 'id'
        property :image_media_metadata, as: 'imageMediaMetadata', class: Google::Apis::DriveV2::File::ImageMediaMetadata do
          ...
          property :location, as: 'location', class: Google::Apis::DriveV2::File::ImageMediaMetadata::Location do
        ...
        property :indexable_text, as: 'indexableText', class: Google::Apis::DriveV2::File::IndexableText do
          property :text, as: 'text'
        end
        
        property :kind, as: 'kind'
        property :labels, as: 'labels', class: Google::Apis::DriveV2::File::Labels do
        ...
        property :thumbnail, as: 'thumbnail', class: Google::Apis::DriveV2::File::Thumbnail do
        ...
        property :video_media_metadata, as: 'videoMediaMetadata', class: Google::Apis::DriveV2::File::VideoMediaMetadata do
      ...
      class UserRepresentation < Google::Apis::Core::JsonRepresentation
        ...
        property :kind, as: 'kind'
        property :permission_id, as: 'permissionId'
        property :picture, as: 'picture', class: Google::Apis::DriveV2::User::Picture do
          property :url, as: 'url'
        end
      end
    end
