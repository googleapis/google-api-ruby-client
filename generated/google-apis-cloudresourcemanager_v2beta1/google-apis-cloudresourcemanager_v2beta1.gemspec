require File.expand_path("lib/google/apis/cloudresourcemanager_v2beta1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudresourcemanager_v2beta1"
  gem.version = Google::Apis::CloudresourcemanagerV2beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Resource Manager API V2beta1"
  gem.description =
      "This is the legacy REST client for Cloud Resource Manager API V2beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudresourcemanager_v2beta1/v#{Google::Apis::CloudresourcemanagerV2beta1::GEM_VERSION}",
