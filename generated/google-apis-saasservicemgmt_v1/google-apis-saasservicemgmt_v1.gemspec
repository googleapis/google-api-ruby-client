...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for SaaS Runtime API V1"
  gem.description =
      "This is the simple REST client for SaaS Runtime API V1." \
      ...
      " this client to access the SaaS Runtime API, but note that some" \
