# Legacy REST client for version V1alpha1 of the Cloud Run Admin API

This is a simple client library for version V1alpha1 of the Cloud Run Admin API. It provides:
...
```ruby
gem 'google-apis-run_v1alpha1', '~> 0.1'
```
...
```
$ gem install google-apis-run_v1alpha1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Run service in particular.)

For reference information on specific calls in the Cloud Run Admin API, see the {Google::Apis::RunV1alpha1::CloudRunService class reference docs}.
