# Legacy REST client for version V1beta of the Policy Troubleshooter API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Policytroubleshooter service in particular.)
