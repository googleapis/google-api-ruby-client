...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::VaultV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for G Suite Vault API V1"
  gem.description =
      "This is the simple REST client for G Suite Vault API V1." \
      ...
      " this client to access the G Suite Vault API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-vault_v1/v#{Google::Apis::VaultV1::GEM_VERSION}",
