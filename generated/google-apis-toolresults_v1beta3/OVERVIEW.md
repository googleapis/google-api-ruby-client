# Legacy REST client for version V1beta3 of the Cloud Tool Results API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Toolresults service in particular.)
