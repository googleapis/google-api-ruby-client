  ...
  module Apis
    module BatchV1
      ...
      class AllocationPolicy
        ...
        # applies predefined labels and supports multiple `labels` fields for each job,
        # which each let you apply custom labels to various resources. Label names that
        # start with "goog-" or "google-" are reserved for predefined labels. For more
        # information about labels with Batch, see [Organize resources using labels](
      ...
      class Job
        ...
        # cloud.google.com/logging/docs/reference/v2/rest/v2/LogEntry) that it generates.
        ...
        # using labels](https://cloud.google.com/batch/docs/organize-resources-using-
        # labels).
        # Corresponds to the JSON property `labels`
        # @return [Hash<String,String>]
        attr_accessor :labels
