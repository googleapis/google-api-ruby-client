...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/adexperiencereport.googleapis.com) in the console.
...
```ruby
gem 'google-apis-adexperiencereport_v1', '~> 0.1'
```
...
```
$ gem install google-apis-adexperiencereport_v1
```
