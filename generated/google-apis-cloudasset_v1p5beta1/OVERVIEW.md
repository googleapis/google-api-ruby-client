# Legacy REST client for version V1p5beta1 of the Cloud Asset API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Cloudasset service in particular.)
