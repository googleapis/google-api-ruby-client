# Legacy REST client for version V1 of the Groups Settings API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Groupssettings service in particular.)
