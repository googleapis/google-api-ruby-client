  ...
  module Apis
    module AnalyticsreportingV4
      ...
      class AnalyticsReportingService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://analyticsreporting.$UNIVERSE_DOMAIN$/"
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-analyticsreporting_v4',
                client_version: Google::Apis::AnalyticsreportingV4::GEM_VERSION)
          @batch_path = 'batch'
        end
