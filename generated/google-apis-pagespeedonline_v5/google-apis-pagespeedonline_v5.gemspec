...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::PagespeedonlineV5::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for PageSpeed Insights API V5"
  gem.description =
      "This is the legacy REST client for PageSpeed Insights API V5." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-pagespeedonline_v5/v#{Google::Apis::PagespeedonlineV5::GEM_VERSION}",
