...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::ApigatewayV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for API Gateway API V1beta"
  gem.description =
      "This is the legacy REST client for API Gateway API V1beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-apigateway_v1beta/v#{Google::Apis::ApigatewayV1beta::GEM_VERSION}",
