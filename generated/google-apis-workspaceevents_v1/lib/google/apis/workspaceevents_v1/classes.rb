...
module Google
  module Apis
    module WorkspaceeventsV1
      ...
      # //developers.google.com/workspace/events/guides).
      class Subscription
        include Google::Apis::Core::Hashable
        ...
        # list of supported event types, see the following documentation: * [Google Chat
        # events](https://developers.google.com/workspace/events/guides/events-chat) * [
        # Google Meet events](https://developers.google.com/workspace/events/guides/
        ...
        # lifecycle). You don't need to specify lifecycle events for this field. If you
        # specify an event type that doesn't exist for the target resource, the request
        ...
        # resource-names). To learn about target resources, see [Supported Google
        # Workspace resources](https://developers.google.com/workspace/events/guides#
        # supported-resources). A user can only authorize your app to create one
        # subscription for a given target resource. If your app tries to create another
