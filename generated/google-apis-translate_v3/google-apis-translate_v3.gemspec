require File.expand_path("lib/google/apis/translate_v3/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-translate_v3"
  gem.version = Google::Apis::TranslateV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Translation API V3"
  gem.description =
      "This is the simple REST client for Cloud Translation API V3." \
      ...
      " this client to access the Cloud Translation API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-translate_v3/v#{Google::Apis::TranslateV3::GEM_VERSION}",
