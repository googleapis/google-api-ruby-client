# Simple REST client for version V3 of the Cloud Translation API

This is a simple client library for version V3 of the Cloud Translation API. It provides:
...
```ruby
gem 'google-apis-translate_v3', '~> 0.1'
```
...
```
$ gem install google-apis-translate_v3
```
...
For reference information on specific calls in the Cloud Translation API, see the {Google::Apis::TranslateV3::TranslateService class reference docs}.
