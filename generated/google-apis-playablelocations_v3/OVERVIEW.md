# Legacy REST client for version V3 of the Playable Locations API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Playablelocations service in particular.)
