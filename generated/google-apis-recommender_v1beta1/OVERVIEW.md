# Simple REST client for version V1beta1 of the Recommender API

This is a simple client library for version V1beta1 of the Recommender API. It provides:
...
```ruby
gem 'google-apis-recommender_v1beta1', '~> 0.1'
```
...
```
$ gem install google-apis-recommender_v1beta1
```
...
For reference information on specific calls in the Recommender API, see the {Google::Apis::RecommenderV1beta1::RecommenderService class reference docs}.
