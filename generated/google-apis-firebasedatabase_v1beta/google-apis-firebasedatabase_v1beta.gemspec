...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Firebase Realtime Database API V1beta"
  gem.description =
      "This is the simple REST client for Firebase Realtime Database API V1beta." \
      ...
      " this client to access the Firebase Realtime Database API, but note that some" \
