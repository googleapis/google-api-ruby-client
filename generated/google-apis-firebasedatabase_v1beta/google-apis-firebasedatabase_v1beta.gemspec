require File.expand_path("lib/google/apis/firebasedatabase_v1beta/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-firebasedatabase_v1beta"
  gem.version = Google::Apis::FirebasedatabaseV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Firebase Realtime Database Management API V1beta"
  gem.description =
      "This is the simple REST client for Firebase Realtime Database Management API V1beta." \
      ...
      " this client to access the Firebase Realtime Database Management API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firebasedatabase_v1beta/v#{Google::Apis::FirebasedatabaseV1beta::GEM_VERSION}",
