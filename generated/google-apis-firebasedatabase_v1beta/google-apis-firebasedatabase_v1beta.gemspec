...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Legacy REST client for Firebase Realtime Database Management API V1beta"
  gem.description =
      "This is the legacy REST client for Firebase Realtime Database Management API V1beta." \
