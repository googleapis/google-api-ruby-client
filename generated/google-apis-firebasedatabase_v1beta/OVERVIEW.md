# Legacy REST client for version V1beta of the Firebase Realtime Database Management API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Firebasedatabase service in particular.)
