# Legacy REST client for version V3 of the Search Console API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Webmasters service in particular.)
