require File.expand_path("lib/google/apis/safebrowsing_v5/gem_version", __dir__)
gem_version = Google::Apis::SafebrowsingV5::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-safebrowsing_v5"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Safe Browsing API V5"
  gem.description =
      "This is the simple REST client for Safe Browsing API V5." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-safebrowsing_v5/v#{gem_version}",
