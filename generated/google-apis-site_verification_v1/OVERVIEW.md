# Legacy REST client for version V1 of the Google Site Verification API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the SiteVerification service in particular.)
