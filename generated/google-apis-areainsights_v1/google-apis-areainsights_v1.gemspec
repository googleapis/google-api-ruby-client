...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Places Insights API V1"
  gem.description =
      "This is the simple REST client for Places Insights API V1." \
      ...
      " this client to access the Places Insights API, but note that some" \
