# Simple REST client for version V2 of the GKE Hub API

This is a simple client library for version V2 of the GKE Hub API. It provides:
...
```
$ gem install google-apis-gkehub_v2
```
...
client = Google::Apis::GkehubV2::GKEHubService.new
...
For reference information on specific calls in the GKE Hub API, see the {Google::Apis::GkehubV2::GKEHubService class reference docs}.
