# Legacy REST client for version V2 of the Stackdriver Profiler API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Cloudprofiler service in particular.)
