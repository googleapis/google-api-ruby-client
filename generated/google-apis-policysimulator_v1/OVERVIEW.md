# Simple REST client for version V1 of the Policy Simulator API

This is a simple client library for version V1 of the Policy Simulator API. It provides:
...
```ruby
gem 'google-apis-policysimulator_v1', '~> 0.1'
```
...
```
$ gem install google-apis-policysimulator_v1
```
...
client = Google::Apis::PolicysimulatorV1::PolicySimulatorService.new
...
For reference information on specific calls in the Policy Simulator API, see the {Google::Apis::PolicysimulatorV1::PolicySimulatorService class reference docs}.
