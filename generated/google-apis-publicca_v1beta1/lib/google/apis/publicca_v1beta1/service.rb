...
module Google
  module Apis
    module PubliccaV1beta1
      ...
      #
      #    Publicca = Google::Apis::PubliccaV1beta1 # Alias the module
      ...
      class PublicCertificateAuthorityService < Google::Apis::Core::BaseService
        ...
        def initialize
          super('https://publicca.googleapis.com/', '',
                client_name: 'google-apis-publicca_v1beta1',
                client_version: Google::Apis::PubliccaV1beta1::GEM_VERSION)
          @batch_path = 'batch'
        end
        ...
        # @param [Google::Apis::PubliccaV1beta1::ExternalAccountKey] external_account_key_object
        # @param [String] fields
        ...
        # @yieldparam result [Google::Apis::PubliccaV1beta1::ExternalAccountKey] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::PubliccaV1beta1::ExternalAccountKey]
        #
        ...
        def create_project_location_external_account_key(parent, external_account_key_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1beta1/{+parent}/externalAccountKeys', options)
          command.request_representation = Google::Apis::PubliccaV1beta1::ExternalAccountKey::Representation
          command.request_object = external_account_key_object
          command.response_representation = Google::Apis::PubliccaV1beta1::ExternalAccountKey::Representation
          command.response_class = Google::Apis::PubliccaV1beta1::ExternalAccountKey
