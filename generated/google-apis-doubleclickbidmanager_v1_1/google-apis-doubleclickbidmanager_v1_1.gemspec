...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DoubleclickbidmanagerV1_1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for DoubleClick Bid Manager API V1_1"
  gem.description =
      "This is the legacy REST client for DoubleClick Bid Manager API V1_1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-doubleclickbidmanager_v1_1/v#{Google::Apis::DoubleclickbidmanagerV1_1::GEM_VERSION}",
