# Legacy REST client for version V1_1 of the DoubleClick Bid Manager API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Doubleclickbidmanager service in particular.)
