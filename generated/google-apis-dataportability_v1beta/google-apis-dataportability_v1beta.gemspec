require File.expand_path("lib/google/apis/dataportability_v1beta/gem_version", __dir__)
gem_version = Google::Apis::DataportabilityV1beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-dataportability_v1beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Data Portability API V1beta"
  gem.description =
      "This is the simple REST client for Data Portability API V1beta." \
      ...
      " this client to access the Data Portability API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dataportability_v1beta/v#{gem_version}",
