require File.expand_path("lib/google/apis/tpu_v1alpha1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-tpu_v1alpha1"
  gem.version = Google::Apis::TpuV1alpha1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud TPU API V1alpha1"
  gem.description =
      "This is the simple REST client for Cloud TPU API V1alpha1." \
      ...
      " this client to access the Cloud TPU API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-tpu_v1alpha1/v#{Google::Apis::TpuV1alpha1::GEM_VERSION}",
