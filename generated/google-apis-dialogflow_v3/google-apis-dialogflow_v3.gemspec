...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DialogflowV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Dialogflow API V3"
  gem.description =
      "This is the legacy REST client for Dialogflow API V3." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dialogflow_v3/v#{Google::Apis::DialogflowV3::GEM_VERSION}",
