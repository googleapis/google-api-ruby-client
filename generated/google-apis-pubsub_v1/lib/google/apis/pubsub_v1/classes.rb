  ...
  module Apis
    module PubsubV1
      ...
      class JavaScriptUdf
        ...
        # below signature: /** * Transforms a Pub/Sub message. * @return `(Object)>|null)
        # ` - To * filter a message, return `null`. To transform a message return a map *
        # with the following keys: * - (required) 'data' : `string` * - (optional) '
