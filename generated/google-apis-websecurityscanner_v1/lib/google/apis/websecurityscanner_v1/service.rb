  ...
  module Apis
    module WebsecurityscannerV1
      ...
      class WebSecurityScannerService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://websecurityscanner.$UNIVERSE_DOMAIN$/"
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-websecurityscanner_v1',
                client_version: Google::Apis::WebsecurityscannerV1::GEM_VERSION)
          @batch_path = 'batch'
        end
