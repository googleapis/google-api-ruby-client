  ...
  module Apis
    module AcceleratedmobilepageurlV1
      ...
      class AcceleratedmobilepageurlService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://acceleratedmobilepageurl.$UNIVERSE_DOMAIN$/"
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-acceleratedmobilepageurl_v1',
                client_version: Google::Apis::AcceleratedmobilepageurlV1::GEM_VERSION)
          @batch_path = 'batch'
        end
