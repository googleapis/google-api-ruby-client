...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DnsV1beta2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud DNS API V1beta2"
  gem.description =
      "This is the legacy REST client for Cloud DNS API V1beta2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dns_v1beta2/v#{Google::Apis::DnsV1beta2::GEM_VERSION}",
