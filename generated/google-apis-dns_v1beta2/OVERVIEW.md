# Simple REST client for version V1beta2 of the Cloud DNS API

This is a simple client library for version V1beta2 of the Cloud DNS API. It provides:
...
```ruby
gem 'google-apis-dns_v1beta2', '~> 0.1'
```
...
```
$ gem install google-apis-dns_v1beta2
```
...
For reference information on specific calls in the Cloud DNS API, see the {Google::Apis::DnsV1beta2::DnsService class reference docs}.
