require File.expand_path("lib/google/apis/adsensehost_v4_1/gem_version", __dir__)
gem_version = Google::Apis::AdsensehostV4_1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-adsensehost_v4_1"
  ...
  gem.description =
      ...
      " this client to access the AdSense Host API, but note that some" \
      " services may provide a separate modern client that is easier to use."
  gem.homepage = "https://github.com/google/google-api-ruby-client"
  gem.license = "Apache-2.0"
  gem.metadata = {
    "bug_tracker_uri" => "https://github.com/googleapis/google-api-ruby-client/issues",
    "changelog_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-adsensehost_v4_1/CHANGELOG.md",
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-adsensehost_v4_1/v#{gem_version}",
    "source_code_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-adsensehost_v4_1"
  }
