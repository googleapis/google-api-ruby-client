# Simple REST client for version V1 of the Transcoder API

This is a simple client library for version V1 of the Transcoder API. It provides:
...
```ruby
gem 'google-apis-transcoder_v1', '~> 0.1'
```
...
```
$ gem install google-apis-transcoder_v1
```
...
client = Google::Apis::TranscoderV1::TranscoderService.new
...
For reference information on specific calls in the Transcoder API, see the {Google::Apis::TranscoderV1::TranscoderService class reference docs}.
