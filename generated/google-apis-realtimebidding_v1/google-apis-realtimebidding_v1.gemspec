...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::RealtimebiddingV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Real-time Bidding API V1"
  gem.description =
      "This is the legacy REST client for Real-time Bidding API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-realtimebidding_v1/v#{Google::Apis::RealtimebiddingV1::GEM_VERSION}",
