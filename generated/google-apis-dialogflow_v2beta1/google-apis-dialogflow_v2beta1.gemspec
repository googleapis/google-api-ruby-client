require File.expand_path("lib/google/apis/dialogflow_v2beta1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-dialogflow_v2beta1"
  gem.version = Google::Apis::DialogflowV2beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Dialogflow API V2beta1"
  gem.description =
      "This is the simple REST client for Dialogflow API V2beta1." \
      ...
      " this client to access the Dialogflow API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dialogflow_v2beta1/v#{Google::Apis::DialogflowV2beta1::GEM_VERSION}",
