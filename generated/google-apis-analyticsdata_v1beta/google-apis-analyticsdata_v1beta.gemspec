require File.expand_path("lib/google/apis/analyticsdata_v1beta/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-analyticsdata_v1beta"
  gem.version = Google::Apis::AnalyticsdataV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Google Analytics Data API V1beta"
  gem.description =
      "This is the simple REST client for Google Analytics Data API V1beta." \
      ...
      " this client to access the Google Analytics Data API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-analyticsdata_v1beta/v#{Google::Apis::AnalyticsdataV1beta::GEM_VERSION}",
