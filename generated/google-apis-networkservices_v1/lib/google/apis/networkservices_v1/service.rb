  ...
  module Apis
    module NetworkservicesV1
      ...
      class NetworkServicesService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::NetworkservicesV1::AgentConnectivityTemplate] agent_connectivity_template_object
        ...
        def create_project_location_agent_connectivity_template(parent, agent_connectivity_template_object = nil, agent_connectivity_template_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/agentConnectivityTemplates', options)
          command.request_representation = Google::Apis::NetworkservicesV1::AgentConnectivityTemplate::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::AgentConnectivityTemplate] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::AgentConnectivityTemplate]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_agent_connectivity_template(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1::AgentConnectivityTemplate::Representation
          command.response_class = Google::Apis::NetworkservicesV1::AgentConnectivityTemplate
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::ListAgentConnectivityTemplatesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::ListAgentConnectivityTemplatesResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_agent_connectivity_templates(parent, page_size: nil, page_token: nil, return_partial_success: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/agentConnectivityTemplates', options)
          command.response_representation = Google::Apis::NetworkservicesV1::ListAgentConnectivityTemplatesResponse::Representation
          command.response_class = Google::Apis::NetworkservicesV1::ListAgentConnectivityTemplatesResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        # @param [Google::Apis::NetworkservicesV1::ExtensionBinding] extension_binding_object
        # @param [String] extension_binding_id
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def create_project_location_extension_binding(parent, extension_binding_object = nil, extension_binding_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/extensionBindings', options)
          command.request_representation = Google::Apis::NetworkservicesV1::ExtensionBinding::Representation
          command.request_object = extension_binding_object
          command.response_representation = Google::Apis::NetworkservicesV1::Operation::Representation
          command.response_class = Google::Apis::NetworkservicesV1::Operation
          command.params['parent'] = parent unless parent.nil?
          command.query['extensionBindingId'] = extension_binding_id unless extension_binding_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        # @param [String] name
        #   Required. A name of the `ExtensionBinding` resource to delete. Must be in the
        #   format `projects/`project`/locations/`location`/extensionBindings/`
        #   extension_binding``.
        # @param [String] etag
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def delete_project_location_extension_binding(name, etag: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:delete, 'v1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1::Operation::Representation
          command.response_class = Google::Apis::NetworkservicesV1::Operation
          command.params['name'] = name unless name.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::ExtensionBinding] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::ExtensionBinding]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_extension_binding(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1::ExtensionBinding::Representation
          command.response_class = Google::Apis::NetworkservicesV1::ExtensionBinding
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        # @param [String] parent
        #   Required. The project and location from which the `ExtensionBinding` resources
        ...
        #   Indicates that this is a continuation of a prior `ListExtensionBindings` call,
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::ListExtensionBindingsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::ListExtensionBindingsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_extension_bindings(parent, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/extensionBindings', options)
          command.response_representation = Google::Apis::NetworkservicesV1::ListExtensionBindingsResponse::Representation
          command.response_class = Google::Apis::NetworkservicesV1::ListExtensionBindingsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def patch_project_location_extension_binding(name, extension_binding_object = nil, update_mask: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:patch, 'v1/{+name}', options)
          command.request_representation = Google::Apis::NetworkservicesV1::ExtensionBinding::Representation
          command.request_object = extension_binding_object
          command.response_representation = Google::Apis::NetworkservicesV1::Operation::Representation
        ...
        # @param [String] parent
        #   Required. The parent resource of the `ProducerExtension` resource. Must be in
        #   the format `projects/`project`/locations/`location``.
        # @param [Google::Apis::NetworkservicesV1::ProducerExtension] producer_extension_object
        # @param [String] producer_extension_id
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def create_project_location_producer_extension(parent, producer_extension_object = nil, producer_extension_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/producerExtensions', options)
          command.request_representation = Google::Apis::NetworkservicesV1::ProducerExtension::Representation
          command.request_object = producer_extension_object
          command.response_representation = Google::Apis::NetworkservicesV1::Operation::Representation
          command.response_class = Google::Apis::NetworkservicesV1::Operation
          command.params['parent'] = parent unless parent.nil?
          command.query['producerExtensionId'] = producer_extension_id unless producer_extension_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        # @param [String] name
        #   Required. A name of the `ProducerExtension` resource to delete. Must be in the
        #   format `projects/`project`/locations/`location`/producerExtensions/`
        #   producer_extension``.
        # @param [String] etag
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def delete_project_location_producer_extension(name, etag: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:delete, 'v1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1::Operation::Representation
          command.response_class = Google::Apis::NetworkservicesV1::Operation
          command.params['name'] = name unless name.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::ProducerExtension] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::ProducerExtension]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_producer_extension(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1::ProducerExtension::Representation
          command.response_class = Google::Apis::NetworkservicesV1::ProducerExtension
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #   resources should be listed, specified in the format `projects/`project`/
        #   locations/`location``.
        # @param [Fixnum] page_size
        ...
        #   Indicates that this is a continuation of a prior `ListProducerExtensions` call,
        #   and that the system should return the next page of data.
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1::ListProducerExtensionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1::ListProducerExtensionsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_producer_extensions(parent, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/producerExtensions', options)
          command.response_representation = Google::Apis::NetworkservicesV1::ListProducerExtensionsResponse::Representation
          command.response_class = Google::Apis::NetworkservicesV1::ListProducerExtensionsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
