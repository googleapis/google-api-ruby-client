require File.expand_path("lib/google/apis/youtube_v3/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-youtube_v3"
  gem.version = Google::Apis::YoutubeV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for YouTube Data API v3 V3"
  gem.description =
      "This is the simple REST client for YouTube Data API v3 V3." \
      ...
      " this client to access the YouTube Data API v3, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-youtube_v3/v#{Google::Apis::YoutubeV3::GEM_VERSION}",
