  ...
  module Apis
    module YoutubeV3
      ...
      class YouTubeService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://youtube.$UNIVERSE_DOMAIN$/"
        ...
        #   content owner. This parameter must be provided if the request is authenticated
        #   with credentials for a CMS content owner user acting on a managed channel. If
