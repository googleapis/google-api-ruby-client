require File.expand_path("lib/google/apis/mybusinesslodging_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-mybusinesslodging_v1"
  gem.version = Google::Apis::MybusinesslodgingV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for My Business Lodging API V1"
  gem.description =
      "This is the simple REST client for My Business Lodging API V1." \
      ...
      " this client to access the My Business Lodging API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-mybusinesslodging_v1/v#{Google::Apis::MybusinesslodgingV1::GEM_VERSION}",
