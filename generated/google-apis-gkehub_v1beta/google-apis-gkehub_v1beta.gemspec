...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::GkehubV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for GKE Hub V1beta"
  gem.description =
      "This is the simple REST client for GKE Hub V1beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-gkehub_v1beta/v#{Google::Apis::GkehubV1beta::GEM_VERSION}",
