  ...
  module Apis
    module NetworkservicesV1beta1
      ...
      class NetworkServicesService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::NetworkservicesV1beta1::ExtensionBinding] extension_binding_object
        ...
        def create_project_location_extension_binding(parent, extension_binding_object = nil, extension_binding_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1beta1/{+parent}/extensionBindings', options)
          command.request_representation = Google::Apis::NetworkservicesV1beta1::ExtensionBinding::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1beta1::ExtensionBinding] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1beta1::ExtensionBinding]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_extension_binding(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1beta1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1beta1::ExtensionBinding::Representation
          command.response_class = Google::Apis::NetworkservicesV1beta1::ExtensionBinding
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1beta1::ListExtensionBindingsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1beta1::ListExtensionBindingsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_extension_bindings(parent, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1beta1/{+parent}/extensionBindings', options)
          command.response_representation = Google::Apis::NetworkservicesV1beta1::ListExtensionBindingsResponse::Representation
          command.response_class = Google::Apis::NetworkservicesV1beta1::ListExtensionBindingsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #   the format `projects/`project`/locations/`location``.
        # @param [Google::Apis::NetworkservicesV1beta1::ProducerExtension] producer_extension_object
        ...
        def create_project_location_producer_extension(parent, producer_extension_object = nil, producer_extension_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1beta1/{+parent}/producerExtensions', options)
          command.request_representation = Google::Apis::NetworkservicesV1beta1::ProducerExtension::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1beta1::ProducerExtension] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1beta1::ProducerExtension]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_producer_extension(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1beta1/{+name}', options)
          command.response_representation = Google::Apis::NetworkservicesV1beta1::ProducerExtension::Representation
          command.response_class = Google::Apis::NetworkservicesV1beta1::ProducerExtension
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::NetworkservicesV1beta1::ListProducerExtensionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::NetworkservicesV1beta1::ListProducerExtensionsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_producer_extensions(parent, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1beta1/{+parent}/producerExtensions', options)
          command.response_representation = Google::Apis::NetworkservicesV1beta1::ListProducerExtensionsResponse::Representation
          command.response_class = Google::Apis::NetworkservicesV1beta1::ListProducerExtensionsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
