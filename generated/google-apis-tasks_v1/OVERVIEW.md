# Legacy REST client for version V1 of the Tasks API
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/tasks.googleapis.com) in the console.
...
```
$ gem install google-apis-tasks_v1
```
...
client = Google::Apis::TasksV1::TasksService.new
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Tasks service in particular.)
