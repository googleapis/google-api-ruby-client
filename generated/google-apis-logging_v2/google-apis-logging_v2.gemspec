require File.expand_path("lib/google/apis/logging_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-logging_v2"
  gem.version = Google::Apis::LoggingV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Logging API V2"
  gem.description =
      "This is the simple REST client for Cloud Logging API V2." \
      ...
      " this client to access the Cloud Logging API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-logging_v2/v#{Google::Apis::LoggingV2::GEM_VERSION}",
