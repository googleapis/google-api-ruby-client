  ...
  module Apis
    module DataportabilityV1
      ...
      class DataPortabilityService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::DataportabilityV1::CancelPortabilityArchiveRequest] cancel_portability_archive_request_object
        # @param [String] fields
        ...
        # @yieldparam result [Google::Apis::DataportabilityV1::CancelPortabilityArchiveResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::DataportabilityV1::CancelPortabilityArchiveResponse]
        #
