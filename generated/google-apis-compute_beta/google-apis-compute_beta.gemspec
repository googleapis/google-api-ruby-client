...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::ComputeBeta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Compute Engine API Beta"
  gem.description =
      "This is the legacy REST client for Compute Engine API Beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-compute_beta/v#{Google::Apis::ComputeBeta::GEM_VERSION}",
