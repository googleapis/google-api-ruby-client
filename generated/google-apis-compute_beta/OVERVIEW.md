# Legacy REST client for version Beta of the Compute Engine API

This is a simple client library for version Beta of the Compute Engine API. It provides:
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/compute.googleapis.com) in the console.
...
```ruby
gem 'google-apis-compute_beta', '~> 0.1'
```
...
```
$ gem install google-apis-compute_beta
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Compute service in particular.)

For reference information on specific calls in the Compute Engine API, see the {Google::Apis::ComputeBeta::ComputeService class reference docs}.
