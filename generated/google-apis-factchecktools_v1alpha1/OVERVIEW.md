# Legacy REST client for version V1alpha1 of the Fact Check Tools API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Factchecktools service in particular.)
