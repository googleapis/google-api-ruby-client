# Legacy REST client for version V1 of the Google Play Game Services
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Games service in particular.)
