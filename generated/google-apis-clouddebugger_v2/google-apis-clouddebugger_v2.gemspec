...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::ClouddebuggerV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Debugger API V2"
  gem.description =
      "This is the legacy REST client for Cloud Debugger API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-clouddebugger_v2/v#{Google::Apis::ClouddebuggerV2::GEM_VERSION}",
