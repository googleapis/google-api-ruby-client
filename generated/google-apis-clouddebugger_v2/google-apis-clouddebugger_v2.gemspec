...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Cloud Debugger API (Deprecated) V2"
  gem.description =
      "This is the simple REST client for Cloud Debugger API (Deprecated) V2." \
      ...
      " this client to access the Cloud Debugger API (Deprecated), but note that some" \
