...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::DialogflowV3beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Dialogflow API V3beta1"
  gem.description =
      "This is the legacy REST client for Dialogflow API V3beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dialogflow_v3beta1/v#{Google::Apis::DialogflowV3beta1::GEM_VERSION}",
