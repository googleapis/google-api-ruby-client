# Legacy REST client for version V1p1beta1 of the Cloud Video Intelligence API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Videointelligence service in particular.)
