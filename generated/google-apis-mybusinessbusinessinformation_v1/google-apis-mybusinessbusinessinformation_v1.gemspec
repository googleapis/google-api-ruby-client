require File.expand_path("lib/google/apis/mybusinessbusinessinformation_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-mybusinessbusinessinformation_v1"
  gem.version = Google::Apis::MybusinessbusinessinformationV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for My Business Business Information API V1"
  gem.description =
      ...
      " this client to access the My Business Business Information API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-mybusinessbusinessinformation_v1/v#{Google::Apis::MybusinessbusinessinformationV1::GEM_VERSION}",
