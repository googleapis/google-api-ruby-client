  ...
  module Apis
    module SqladminV1
      ...
      class SQLAdminService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::SqladminV1::BlueGreenDeployment] blue_green_deployment_object
        ...
        def create_blue_green_deployment(parent, blue_green_deployment_object = nil, blue_green_deployment_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/blueGreenDeployments', options)
          command.request_representation = Google::Apis::SqladminV1::BlueGreenDeployment::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::SqladminV1::BlueGreenDeployment] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::SqladminV1::BlueGreenDeployment]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_blue_green_deployment(name, view: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::SqladminV1::BlueGreenDeployment::Representation
          command.response_class = Google::Apis::SqladminV1::BlueGreenDeployment
          command.params['name'] = name unless name.nil?
        ...
        #   fewer deployments than this value. If unspecified, at most 500 deployments are
        #   returned. The maximum value is 1000; values above 1000 are treated as 1000.
        # @param [String] page_token
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::SqladminV1::ListBlueGreenDeploymentsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::SqladminV1::ListBlueGreenDeploymentsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_blue_green_deployments(parent, filter: nil, order_by: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/blueGreenDeployments', options)
          command.response_representation = Google::Apis::SqladminV1::ListBlueGreenDeploymentsResponse::Representation
          command.response_class = Google::Apis::SqladminV1::ListBlueGreenDeploymentsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
        ...
        # @param [Google::Apis::SqladminV1::SwitchoverBlueGreenDeploymentRequest] switchover_blue_green_deployment_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def switchover_blue_green_deployment(name, switchover_blue_green_deployment_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::SqladminV1::SwitchoverBlueGreenDeploymentRequest::Representation
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def clone_instance(project, instance, instances_clone_request_object = nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def export_instance(project, instance, instances_export_request_object = nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def import_instance(project, instance, instances_import_request_object = nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def restore_instance_backup(project, instance, instances_restore_backup_request_object = nil, location: nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::SqladminV1::WorkloadCapturesListResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::SqladminV1::WorkloadCapturesListResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_workload_captures(project, instance, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/projects/{project}/instances/{instance}/workloadCaptures', options)
          command.response_representation = Google::Apis::SqladminV1::WorkloadCapturesListResponse::Representation
          command.response_class = Google::Apis::SqladminV1::WorkloadCapturesListResponse
          command.params['project'] = project unless project.nil?
          command.params['instance'] = instance unless instance.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        # @param [String] instance
        #   Required. Cloud SQL instance ID. This does not include the project ID.
        # @param [Google::Apis::SqladminV1::SqlWorkloadCapturesStartRequest] sql_workload_captures_start_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def start_workload_capture(project, instance, sql_workload_captures_start_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/projects/{project}/instances/{instance}/workloadCaptures:start', options)
          command.request_representation = Google::Apis::SqladminV1::SqlWorkloadCapturesStartRequest::Representation
        ...
        # @param [Google::Apis::SqladminV1::SqlWorkloadCapturesStartReplayRequest] sql_workload_captures_start_replay_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def start_workload_capture_replay(project, instance, workload_id, sql_workload_captures_start_replay_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:startReplay', options)
          command.request_representation = Google::Apis::SqladminV1::SqlWorkloadCapturesStartReplayRequest::Representation
        ...
        # @param [String] instance
        #   Required. Cloud SQL instance ID. This does not include the project ID.
        # @param [Google::Apis::SqladminV1::SqlWorkloadCapturesStopRequest] sql_workload_captures_stop_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def stop_workload_capture(project, instance, sql_workload_captures_stop_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/projects/{project}/instances/{instance}/workloadCaptures:stop', options)
          command.request_representation = Google::Apis::SqladminV1::SqlWorkloadCapturesStopRequest::Representation
        ...
        # @param [String] workload_id
        #   Required. The ID of the workload to replay.
        # @param [Google::Apis::SqladminV1::SqlWorkloadCapturesStopReplayRequest] sql_workload_captures_stop_replay_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def stop_workload_capture_replay(project, instance, workload_id, sql_workload_captures_stop_replay_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:stopReplay', options)
          command.request_representation = Google::Apis::SqladminV1::SqlWorkloadCapturesStopReplayRequest::Representation
