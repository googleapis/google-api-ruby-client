...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::CalendarV3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Calendar API V3"
  gem.description =
      "This is the legacy REST client for Calendar API V3." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-calendar_v3/v#{Google::Apis::CalendarV3::GEM_VERSION}",
