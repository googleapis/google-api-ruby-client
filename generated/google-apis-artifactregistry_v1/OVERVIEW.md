# Simple REST client for version V1 of the Artifact Registry API

This is a simple client library for version V1 of the Artifact Registry API. It provides:
...
```ruby
gem 'google-apis-artifactregistry_v1', '~> 0.1'
```
...
```
$ gem install google-apis-artifactregistry_v1
```
...
For reference information on specific calls in the Artifact Registry API, see the {Google::Apis::ArtifactregistryV1::ArtifactRegistryService class reference docs}.
