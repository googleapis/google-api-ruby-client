require File.expand_path("lib/google/apis/servicecontrol_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-servicecontrol_v2"
  gem.version = Google::Apis::ServicecontrolV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Service Control API V2"
  gem.description =
      "This is the simple REST client for Service Control API V2." \
      ...
      " this client to access the Service Control API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-servicecontrol_v2/v#{Google::Apis::ServicecontrolV2::GEM_VERSION}",
