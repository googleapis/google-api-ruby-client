# Legacy REST client for version V2 of the Service Control API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Servicecontrol service in particular.)
