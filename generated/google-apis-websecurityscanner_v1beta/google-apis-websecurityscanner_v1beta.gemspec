...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::WebsecurityscannerV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Web Security Scanner API V1beta"
  gem.description =
      "This is the legacy REST client for Web Security Scanner API V1beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-websecurityscanner_v1beta/v#{Google::Apis::WebsecurityscannerV1beta::GEM_VERSION}",
