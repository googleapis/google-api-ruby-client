# Legacy REST client for version V1alpha2 of the Genomics API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Genomics service in particular.)
