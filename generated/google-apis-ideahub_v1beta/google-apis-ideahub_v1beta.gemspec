require File.expand_path("lib/google/apis/ideahub_v1beta/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-ideahub_v1beta"
  gem.version = Google::Apis::IdeahubV1beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Idea Hub API V1beta"
  gem.description =
      "This is the simple REST client for Idea Hub API V1beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-ideahub_v1beta/v#{Google::Apis::IdeahubV1beta::GEM_VERSION}",
