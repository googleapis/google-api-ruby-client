require File.expand_path("lib/google/apis/apikeys_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-apikeys_v2"
  gem.version = Google::Apis::ApikeysV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for API Keys API V2"
  gem.description =
      "This is the simple REST client for API Keys API V2." \
      ...
      " this client to access the API Keys API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-apikeys_v2/v#{Google::Apis::ApikeysV2::GEM_VERSION}",
