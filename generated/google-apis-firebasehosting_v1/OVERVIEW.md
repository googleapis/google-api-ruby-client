# Legacy REST client for version V1 of the Firebase Hosting API

This is a simple client library for version V1 of the Firebase Hosting API. It provides:
...
```ruby
gem 'google-apis-firebasehosting_v1', '~> 0.1'
```
...
```
$ gem install google-apis-firebasehosting_v1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Firebasehosting service in particular.)

For reference information on specific calls in the Firebase Hosting API, see the {Google::Apis::FirebasehostingV1::FirebaseHostingService class reference docs}.
