...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Document AI Warehouse API V1"
  gem.description =
      "This is the simple REST client for Document AI Warehouse API V1." \
      ...
      " this client to access the Document AI Warehouse API, but note that some" \
