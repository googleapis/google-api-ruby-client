  ...
  module Apis
    module PeopleV1
      ...
      class PeopleServiceService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://people.$UNIVERSE_DOMAIN$/"
        ...
        # updates into the latest person. If making sequential updates to the same
        # person, the etag from the `updateContact` response should be used to avoid
        # failures. The server returns a 400 error if `memberships` are being updated
