...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::TranslateV3beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Translation API V3beta1"
  gem.description =
      "This is the legacy REST client for Cloud Translation API V3beta1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-translate_v3beta1/v#{Google::Apis::TranslateV3beta1::GEM_VERSION}",
