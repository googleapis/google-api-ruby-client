  ...
  module Apis
    module VideointelligenceV1p3beta1
      ...
      class CloudVideoIntelligenceService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://videointelligence.$UNIVERSE_DOMAIN$/"
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-videointelligence_v1p3beta1',
                client_version: Google::Apis::VideointelligenceV1p3beta1::GEM_VERSION)
          @batch_path = 'batch'
        end
