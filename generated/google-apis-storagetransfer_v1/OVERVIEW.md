# Legacy REST client for version V1 of the Storage Transfer API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Storagetransfer service in particular.)
