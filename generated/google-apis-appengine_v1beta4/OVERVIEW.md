# Legacy REST client for version V1beta4 of the App Engine Admin API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Appengine service in particular.)
