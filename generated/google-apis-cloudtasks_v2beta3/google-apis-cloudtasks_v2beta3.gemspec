require File.expand_path("lib/google/apis/cloudtasks_v2beta3/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudtasks_v2beta3"
  gem.version = Google::Apis::CloudtasksV2beta3::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Tasks API V2beta3"
  gem.description =
      "This is the simple REST client for Cloud Tasks API V2beta3." \
      ...
      " this client to access the Cloud Tasks API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudtasks_v2beta3/v#{Google::Apis::CloudtasksV2beta3::GEM_VERSION}",
