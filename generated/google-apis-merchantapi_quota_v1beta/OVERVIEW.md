# Simple REST client for version QuotaV1beta of the Merchant API

This is a simple client library for version QuotaV1beta of the Merchant API. It provides:
...
```ruby
gem 'google-apis-merchantapi_quota_v1beta', '~> 0.1'
```
...
```
$ gem install google-apis-merchantapi_quota_v1beta
```
...
client = Google::Apis::MerchantapiQuotaV1beta::MerchantService.new
...
For reference information on specific calls in the Merchant API, see the {Google::Apis::MerchantapiQuotaV1beta::MerchantService class reference docs}.
