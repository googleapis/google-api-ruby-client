require File.expand_path("lib/google/apis/content_v2/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-content_v2"
  gem.version = Google::Apis::ContentV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Content API for Shopping V2"
  gem.description =
      "This is the simple REST client for Content API for Shopping V2." \
      ...
      " this client to access the Content API for Shopping, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-content_v2/v#{Google::Apis::ContentV2::GEM_VERSION}",
