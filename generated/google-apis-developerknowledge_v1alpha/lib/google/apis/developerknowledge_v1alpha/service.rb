...
module Google
  module Apis
    module DeveloperknowledgeV1alpha
      ...
      #
      #    Developerknowledge = Google::Apis::DeveloperknowledgeV1alpha # Alias the module
      ...
      class DeveloperKnowledgeService < Google::Apis::Core::BaseService
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-developerknowledge_v1alpha',
                client_version: Google::Apis::DeveloperknowledgeV1alpha::GEM_VERSION)
          @batch_path = 'batch'
        end
        ...
        # @yieldparam result [Google::Apis::DeveloperknowledgeV1alpha::BatchGetDocumentsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::DeveloperknowledgeV1alpha::BatchGetDocumentsResponse]
        #
        ...
        def batch_document_get(names: nil, view: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/documents:batchGet', options)
          command.response_representation = Google::Apis::DeveloperknowledgeV1alpha::BatchGetDocumentsResponse::Representation
          command.response_class = Google::Apis::DeveloperknowledgeV1alpha::BatchGetDocumentsResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::DeveloperknowledgeV1alpha::Document] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        def get_document(name, view: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::DeveloperknowledgeV1alpha::Document::Representation
          command.response_class = Google::Apis::DeveloperknowledgeV1alpha::Document
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::DeveloperknowledgeV1alpha::SearchDocumentChunksResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::DeveloperknowledgeV1alpha::SearchDocumentChunksResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def search_document_document_chunks(filter: nil, page_size: nil, page_token: nil, query: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/documents:searchDocumentChunks', options)
          command.response_representation = Google::Apis::DeveloperknowledgeV1alpha::SearchDocumentChunksResponse::Representation
          command.response_class = Google::Apis::DeveloperknowledgeV1alpha::SearchDocumentChunksResponse
        ...
        # @param [Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryRequest] answer_query_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def answer_query(answer_query_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1alpha:answerQuery', options)
          command.request_representation = Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryRequest::Representation
          command.request_object = answer_query_request_object
          command.response_representation = Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryResponse::Representation
          command.response_class = Google::Apis::DeveloperknowledgeV1alpha::AnswerQueryResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
