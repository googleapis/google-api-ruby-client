# Simple REST client for version V3 of the Display & Video 360 API

This is a simple client library for version V3 of the Display & Video 360 API. It provides:
...
```ruby
gem 'google-apis-displayvideo_v3', '~> 0.1'
```
...
```
$ gem install google-apis-displayvideo_v3
```
...
client = Google::Apis::DisplayvideoV3::DisplayVideoService.new
...
For reference information on specific calls in the Display & Video 360 API, see the {Google::Apis::DisplayvideoV3::DisplayVideoService class reference docs}.
