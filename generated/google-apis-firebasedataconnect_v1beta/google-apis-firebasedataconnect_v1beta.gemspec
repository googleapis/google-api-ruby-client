...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Firebase SQL Connect API V1beta"
  gem.description =
      "This is the simple REST client for Firebase SQL Connect API V1beta." \
      ...
      " this client to access the Firebase SQL Connect API, but note that some" \
