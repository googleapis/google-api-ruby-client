require File.expand_path("lib/google/apis/firebasedataconnect_v1beta/gem_version", __dir__)
gem_version = Google::Apis::FirebasedataconnectV1beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-firebasedataconnect_v1beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Firebase Data Connect API V1beta"
  gem.description =
      "This is the simple REST client for Firebase Data Connect API V1beta." \
      ...
      " this client to access the Firebase Data Connect API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firebasedataconnect_v1beta/v#{gem_version}",
