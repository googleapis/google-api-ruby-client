...
```ruby
gem 'google-apis-firebasedataconnect_v1beta', '~> 0.1'
```
...
```
$ gem install google-apis-firebasedataconnect_v1beta
```
...
client = Google::Apis::FirebasedataconnectV1beta::FirebaseDataConnectService.new
