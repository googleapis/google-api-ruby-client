require File.expand_path("lib/google/apis/sasportal_v1alpha1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-sasportal_v1alpha1"
  gem.version = Google::Apis::SasportalV1alpha1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for SAS Portal API V1alpha1"
  gem.description =
      "This is the simple REST client for SAS Portal API V1alpha1." \
      ...
      " this client to access the SAS Portal API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-sasportal_v1alpha1/v#{Google::Apis::SasportalV1alpha1::GEM_VERSION}",
