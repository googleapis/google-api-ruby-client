# Simple REST client for version V2beta of the Identity and Access Management (IAM) API

This is a simple client library for version V2beta of the Identity and Access Management (IAM) API. It provides:
...
```ruby
gem 'google-apis-iam_v2beta', '~> 0.1'
```
...
```
$ gem install google-apis-iam_v2beta
```
...
client = Google::Apis::IamV2beta::IamService.new
...
For reference information on specific calls in the Identity and Access Management (IAM) API, see the {Google::Apis::IamV2beta::IamService class reference docs}.
