require File.expand_path("lib/google/apis/iam_v2beta/gem_version", __dir__)
gem_version = Google::Apis::IamV2beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-iam_v2beta"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Identity and Access Management (IAM) API V2beta"
  gem.description =
      "This is the simple REST client for Identity and Access Management (IAM) API V2beta." \
      ...
      " this client to access the Identity and Access Management (IAM) API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-iam_v2beta/v#{gem_version}",
