...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::FirebaserulesV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Firebase Rules API V1"
  gem.description =
      "This is the legacy REST client for Firebase Rules API V1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-firebaserules_v1/v#{Google::Apis::FirebaserulesV1::GEM_VERSION}",
