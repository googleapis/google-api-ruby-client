...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Cloud Deploy API V1"
  gem.description =
      "This is the simple REST client for Cloud Deploy API V1." \
      ...
      " this client to access the Cloud Deploy API, but note that some" \
