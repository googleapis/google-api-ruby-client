require File.expand_path("lib/google/apis/dfareporting_v3_5/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-dfareporting_v3_5"
  gem.version = Google::Apis::DfareportingV3_5::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Campaign Manager 360 API V3_5"
  gem.description =
      "This is the simple REST client for Campaign Manager 360 API V3_5." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-dfareporting_v3_5/v#{Google::Apis::DfareportingV3_5::GEM_VERSION}",
