require File.expand_path("lib/google/apis/androidpublisher_v3/gem_version", __dir__)
gem_version = Google::Apis::AndroidpublisherV3::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-androidpublisher_v3"
  ...
  gem.description =
      ...
      " this client to access the Google Play Android Developer API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-androidpublisher_v3/v#{gem_version}",
