# Legacy REST client for version V2beta1 of the Cloud Trace API

This is a simple client library for version V2beta1 of the Cloud Trace API. It provides:
...
```ruby
gem 'google-apis-cloudtrace_v2beta1', '~> 0.1'
```
...
```
$ gem install google-apis-cloudtrace_v2beta1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Cloudtrace service in particular.)

For reference information on specific calls in the Cloud Trace API, see the {Google::Apis::CloudtraceV2beta1::CloudTraceService class reference docs}.
