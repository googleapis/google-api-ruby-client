require File.expand_path("lib/google/apis/cloudtrace_v2beta1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-cloudtrace_v2beta1"
  gem.version = Google::Apis::CloudtraceV2beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Trace API V2beta1"
  gem.description =
      "This is the simple REST client for Cloud Trace API V2beta1." \
      ...
      " this client to access the Cloud Trace API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-cloudtrace_v2beta1/v#{Google::Apis::CloudtraceV2beta1::GEM_VERSION}",
