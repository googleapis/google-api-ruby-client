  ...
  module Apis
    module DeploymentmanagerV2
      ...
      class GetHealthOperationMetadata
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :health_info, as: 'healthInfo', class: Google::Apis::DeploymentmanagerV2::GetHealthOperationMetadataHealthInfo, decorator: Google::Apis::DeploymentmanagerV2::GetHealthOperationMetadataHealthInfo::Representation
      ...
      class Operation
        ...
        class Representation < Google::Apis::Core::JsonRepresentation
          ...
          property :description, as: 'description'
          property :details, as: 'details', class: Google::Apis::DeploymentmanagerV2::OperationDetails, decorator: Google::Apis::DeploymentmanagerV2::OperationDetails::Representation
          ...
          property :get_health_operation_metadata, as: 'getHealthOperationMetadata', class: Google::Apis::DeploymentmanagerV2::GetHealthOperationMetadata, decorator: Google::Apis::DeploymentmanagerV2::GetHealthOperationMetadata::Representation
          ...
          property :instances_troubleshoot_operation_metadata, as: 'instancesTroubleshootOperationMetadata', class: Google::Apis::DeploymentmanagerV2::InstancesTroubleshootOperationMetadata, decorator: Google::Apis::DeploymentmanagerV2::InstancesTroubleshootOperationMetadata::Representation
