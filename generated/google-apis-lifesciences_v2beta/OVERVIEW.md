# Legacy REST client for version V2beta of the Cloud Life Sciences API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Lifesciences service in particular.)
