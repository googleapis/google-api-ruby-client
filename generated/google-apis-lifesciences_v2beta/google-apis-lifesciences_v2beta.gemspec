...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::LifesciencesV2beta::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Cloud Life Sciences API V2beta"
  gem.description =
      "This is the legacy REST client for Cloud Life Sciences API V2beta." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-lifesciences_v2beta/v#{Google::Apis::LifesciencesV2beta::GEM_VERSION}",
