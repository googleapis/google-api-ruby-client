...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::Oauth2V2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Google OAuth2 API V2"
  gem.description =
      "This is the legacy REST client for Google OAuth2 API V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-oauth2_v2/v#{Google::Apis::Oauth2V2::GEM_VERSION}",
