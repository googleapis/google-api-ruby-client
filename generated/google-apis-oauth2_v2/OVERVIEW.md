# Legacy REST client for version V2 of the Google OAuth2 API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Oauth2 service in particular.)
