  ...
  module Apis
    module FirebasedataconnectV1
      ...
      class FirebaseDataConnectService < Google::Apis::Core::BaseService
        ...
        #   Format: projects/`project`/locations/`location`/services/`service`
        # @param [Google::Apis::FirebasedataconnectV1::GenerateQueryRequest] generate_query_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::FirebasedataconnectV1::GenerateQueryResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::FirebasedataconnectV1::GenerateQueryResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def generate_service_query(name, generate_query_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+name}:generateQuery', options)
          command.request_representation = Google::Apis::FirebasedataconnectV1::GenerateQueryRequest::Representation
          command.request_object = generate_query_request_object
          command.response_representation = Google::Apis::FirebasedataconnectV1::GenerateQueryResponse::Representation
          command.response_class = Google::Apis::FirebasedataconnectV1::GenerateQueryResponse
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #   Format: projects/`project`/locations/`location`/services/`service`
        # @param [Google::Apis::FirebasedataconnectV1::GenerateSchemaRequest] generate_schema_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::FirebasedataconnectV1::GenerateSchemaResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::FirebasedataconnectV1::GenerateSchemaResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def generate_service_schema(name, generate_schema_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+name}:generateSchema', options)
          command.request_representation = Google::Apis::FirebasedataconnectV1::GenerateSchemaRequest::Representation
          command.request_object = generate_schema_request_object
          command.response_representation = Google::Apis::FirebasedataconnectV1::GenerateSchemaResponse::Representation
          command.response_class = Google::Apis::FirebasedataconnectV1::GenerateSchemaResponse
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
