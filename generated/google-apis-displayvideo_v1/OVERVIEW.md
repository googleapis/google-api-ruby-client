# Legacy REST client for version V1 of the Display & Video 360 API

This is a simple client library for version V1 of the Display & Video 360 API. It provides:
...
```ruby
gem 'google-apis-displayvideo_v1', '~> 0.1'
```
...
```
$ gem install google-apis-displayvideo_v1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Displayvideo service in particular.)

For reference information on specific calls in the Display & Video 360 API, see the {Google::Apis::DisplayvideoV1::DisplayVideoService class reference docs}.
