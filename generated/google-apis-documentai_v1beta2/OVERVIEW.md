# Legacy REST client for version V1beta2 of the Cloud Document AI API

This is a simple client library for version V1beta2 of the Cloud Document AI API. It provides:
...
```ruby
gem 'google-apis-documentai_v1beta2', '~> 0.1'
```
...
```
$ gem install google-apis-documentai_v1beta2
```
...
For reference information on specific calls in the Cloud Document AI API, see the {Google::Apis::DocumentaiV1beta2::DocumentService class reference docs}.
