# Legacy REST client for version V1beta of the Service Networking API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Servicenetworking service in particular.)
