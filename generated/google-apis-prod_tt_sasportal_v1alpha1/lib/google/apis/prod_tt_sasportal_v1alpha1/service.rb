  ...
  module Apis
    module ProdTtSasportalV1alpha1
      ...
      class SASPortalTestingService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::ProdTtSasportalV1alpha1::SasPortalMigrateOrganizationRequest] sas_portal_migrate_organization_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        # @param [Google::Apis::ProdTtSasportalV1alpha1::SasPortalSetupSasAnalyticsRequest] sas_portal_setup_sas_analytics_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
