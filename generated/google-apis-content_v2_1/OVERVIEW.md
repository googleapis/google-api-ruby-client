# Legacy REST client for version V2_1 of the Content API for Shopping

This is a simple client library for version V2_1 of the Content API for Shopping. It provides:
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/content.googleapis.com) in the console.
...
```ruby
gem 'google-apis-content_v2_1', '~> 0.1'
```
...
```
$ gem install google-apis-content_v2_1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Content service in particular.)

For reference information on specific calls in the Content API for Shopping, see the {Google::Apis::ContentV2_1::ShoppingContentService class reference docs}.
...
The [product documentation](https://developers.google.com/shopping-content/v2/) may provide guidance regarding the preferred client library to use.
