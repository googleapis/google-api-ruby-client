...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::ContentV2_1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Legacy REST client for Content API for Shopping V2_1"
  gem.description =
      "This is the legacy REST client for Content API for Shopping V2_1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-content_v2_1/v#{Google::Apis::ContentV2_1::GEM_VERSION}",
