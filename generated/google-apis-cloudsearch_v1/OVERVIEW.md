# Legacy REST client for version V1 of the Cloud Search API

This is a simple client library for version V1 of the Cloud Search API. It provides:
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/cloudsearch.googleapis.com) in the console.
...
```ruby
gem 'google-apis-cloudsearch_v1', '~> 0.1'
```
...
```
$ gem install google-apis-cloudsearch_v1
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Cloudsearch service in particular.)

For reference information on specific calls in the Cloud Search API, see the {Google::Apis::CloudsearchV1::CloudSearchService class reference docs}.
