require File.expand_path("lib/google/apis/datafusion_v1beta1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-datafusion_v1beta1"
  gem.version = Google::Apis::DatafusionV1beta1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Cloud Data Fusion API V1beta1"
  gem.description =
      "This is the simple REST client for Cloud Data Fusion API V1beta1." \
      ...
      " this client to access the Cloud Data Fusion API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-datafusion_v1beta1/v#{Google::Apis::DatafusionV1beta1::GEM_VERSION}",
