  ...
  module Apis
    module ContactcenterinsightsV1
      ...
      class ContactcenterinsightsService < Google::Apis::Core::BaseService
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def create_project_location_qa_question_tag(parent, google_cloud_contactcenterinsights_v1_qa_question_tag_object = nil, fields: nil, quota_user: nil, options: nil, &block)
        ...
        #   indicates that more data is available.
        # @param [String] page_token
        #   Optional. The value returned by the last `ListQaQuestionTagsResponse`. This
        #   value indicates that this is a continuation of a prior `ListQaQuestionTags`
        #   call and that the system should return the next page of data.
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_qa_question_tags(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
