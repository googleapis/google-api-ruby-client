  ...
  module Apis
    module ContactcenterinsightsV1
      ...
      class ContactcenterinsightsService < Google::Apis::Core::BaseService
        ...
        # @param [String] parent
        #   Required. The parent resource where this assistant session will be created.
        #   Format: projects/`project`/locations/`location`
        # @param [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession] google_cloud_contactcenterinsights_v1_assistant_session_object
        # @param [String] assistant_session_id
        #   Optional. The ID to use for the assistant session, which will become the final
        #   component of the assistant session's resource name. If not provided, a random
        #   UUID will be generated by the server. This value should be 4-64 characters and
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def create_project_location_assistant_session(parent, google_cloud_contactcenterinsights_v1_assistant_session_object = nil, assistant_session_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/assistantSessions', options)
          command.request_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession::Representation
          command.request_object = google_cloud_contactcenterinsights_v1_assistant_session_object
          command.response_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession::Representation
          command.response_class = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession
          command.params['parent'] = parent unless parent.nil?
          command.query['assistantSessionId'] = assistant_session_id unless assistant_session_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        # @param [String] name
        #   Required. The name of the assistant session to retrieve. Format: `projects/`
        #   project`/locations/`location`/assistantSessions/`assistant_session``
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_assistant_session(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession::Representation
          command.response_class = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1AssistantSession
          command.params['name'] = name unless name.nil?
        ...
        # @param [String] parent
        #   Required. The parent resource, which owns this collection of assistant
        #   sessions. Format: `projects/`project`/locations/`location``
        # @param [String] filter
        #   Optional. A filter to reduce results to a specific subset.
        # @param [Fixnum] page_size
        #   Optional. The maximum number of assistant sessions to return in a single
        #   response. If unspecified, at most 100 assistant sessions will be returned. The
        #   maximum value is 1000; values above 1000 will be coerced to 1000.
        # @param [String] page_token
        #   Optional. A page token, received from a previous `ListAssistantSessions` call.
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_assistant_sessions(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/assistantSessions', options)
          command.response_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse::Representation
          command.response_class = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
        ...
        # @param [String] name
        #   Required. The name of the assistant session to stream chat. Format: `projects/`
        #   project`/locations/`location`/assistantSessions/`assistant_session``
        # @param [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatRequest] google_cloud_contactcenterinsights_v1_stream_chat_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def stream_project_location_assistant_session_chat(name, google_cloud_contactcenterinsights_v1_stream_chat_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+name}:streamChat', options)
          command.request_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatRequest::Representation
          command.request_object = google_cloud_contactcenterinsights_v1_stream_chat_request_object
          command.response_representation = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatResponse::Representation
          command.response_class = Google::Apis::ContactcenterinsightsV1::GoogleCloudContactcenterinsightsV1StreamChatResponse
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
