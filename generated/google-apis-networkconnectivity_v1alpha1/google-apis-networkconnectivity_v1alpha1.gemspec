require File.expand_path("lib/google/apis/networkconnectivity_v1alpha1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-networkconnectivity_v1alpha1"
  gem.version = Google::Apis::NetworkconnectivityV1alpha1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Network Connectivity API V1alpha1"
  gem.description =
      "This is the simple REST client for Network Connectivity API V1alpha1." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-networkconnectivity_v1alpha1/v#{Google::Apis::NetworkconnectivityV1alpha1::GEM_VERSION}",
