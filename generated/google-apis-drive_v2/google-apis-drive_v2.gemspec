...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Google Drive API V2"
  gem.description =
      "This is the simple REST client for Google Drive API V2." \
      ...
      " this client to access the Google Drive API, but note that some" \
