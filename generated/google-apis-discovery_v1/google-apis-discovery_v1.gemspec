require File.expand_path("lib/google/apis/discovery_v1/gem_version", __dir__)

Gem::Specification.new do |gem|
  gem.name = "google-apis-discovery_v1"
  gem.version = Google::Apis::DiscoveryV1::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for API Discovery Service V1"
  gem.description =
      "This is the simple REST client for API Discovery Service V1." \
      ...
      " this client to access the API Discovery Service, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-discovery_v1/v#{Google::Apis::DiscoveryV1::GEM_VERSION}",
