  ...
  module Apis
    module CloudfunctionsV2beta
      ...
      class Runtime
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :decommission_date, as: 'decommissionDate', class: Google::Apis::CloudfunctionsV2beta::Date, decorator: Google::Apis::CloudfunctionsV2beta::Date::Representation
      
          property :deprecation_date, as: 'deprecationDate', class: Google::Apis::CloudfunctionsV2beta::Date, decorator: Google::Apis::CloudfunctionsV2beta::Date::Representation
