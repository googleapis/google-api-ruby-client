...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for Cloud Data Loss Prevention (DLP) V2"
  gem.description =
      "This is the simple REST client for Cloud Data Loss Prevention (DLP) V2." \
      ...
      " this client to access the Cloud Data Loss Prevention (DLP), but note that some" \
