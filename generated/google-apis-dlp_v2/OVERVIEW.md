# Legacy REST client for version V2 of the Cloud Data Loss Prevention (DLP) API
...
There are a few setup steps you need to complete before you can use this library:
 ...
 3. Most APIs need to be enabled for your project. [Enable it](https://console.cloud.google.com/apis/library/dlp.googleapis.com) in the console.
...
```
$ gem install google-apis-dlp_v2
```
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Dlp service in particular.)
