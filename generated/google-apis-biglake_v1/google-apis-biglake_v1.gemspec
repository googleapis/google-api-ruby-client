...
Gem::Specification.new do |gem|
  ...
  gem.summary = "Simple REST client for BigLake API V1"
  gem.description =
      "This is the simple REST client for BigLake API V1." \
      ...
      " this client to access the BigLake API, but note that some" \
