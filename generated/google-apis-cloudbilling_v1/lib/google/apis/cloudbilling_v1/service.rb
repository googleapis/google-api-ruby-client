  ...
  module Apis
    module CloudbillingV1
      ...
      class CloudbillingService < Google::Apis::Core::BaseService
        ...
        # @param [Google::Apis::CloudbillingV1::SendMessageRequest] send_message_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::SendMessageResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::SendMessageResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def send_message(send_message_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/message:send', options)
          command.request_representation = Google::Apis::CloudbillingV1::SendMessageRequest::Representation
          command.request_object = send_message_request_object
          command.response_representation = Google::Apis::CloudbillingV1::SendMessageResponse::Representation
          command.response_class = Google::Apis::CloudbillingV1::SendMessageResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::StreamResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::StreamResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def stream_message(send_message_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::CloudbillingV1::SendMessageRequest::Representation
          command.request_object = send_message_request_object
          command.response_representation = Google::Apis::CloudbillingV1::StreamResponse::Representation
          command.response_class = Google::Apis::CloudbillingV1::StreamResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        end
        ...
        # @param [Google::Apis::CloudbillingV1::CancelTaskRequest] cancel_task_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::Task] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        def cancel_task(name, cancel_task_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::CloudbillingV1::CancelTaskRequest::Representation
          command.request_object = cancel_task_request_object
          command.response_representation = Google::Apis::CloudbillingV1::Task::Representation
          command.response_class = Google::Apis::CloudbillingV1::Task
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        # @param [Google::Apis::CloudbillingV1::TaskPushNotificationConfig] task_push_notification_config_object
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::TaskPushNotificationConfig] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::TaskPushNotificationConfig]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def create_task_push_notification_config(parent, task_push_notification_config_object = nil, config_id: nil, tenant: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::CloudbillingV1::TaskPushNotificationConfig::Representation
          command.request_object = task_push_notification_config_object
          command.response_representation = Google::Apis::CloudbillingV1::TaskPushNotificationConfig::Representation
          command.response_class = Google::Apis::CloudbillingV1::TaskPushNotificationConfig
          command.params['parent'] = parent unless parent.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::Empty]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def delete_task_push_notification_config(name, tenant: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::CloudbillingV1::Empty::Representation
          command.response_class = Google::Apis::CloudbillingV1::Empty
          command.params['name'] = name unless name.nil?
          command.query['tenant'] = tenant unless tenant.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::ListTaskPushNotificationConfigResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::ListTaskPushNotificationConfigResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_task_push_notification_configs(parent, page_size: nil, page_token: nil, tenant: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::CloudbillingV1::ListTaskPushNotificationConfigResponse::Representation
          command.response_class = Google::Apis::CloudbillingV1::ListTaskPushNotificationConfigResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['tenant'] = tenant unless tenant.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudbillingV1::AgentCard] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudbillingV1::AgentCard]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_card(tenant: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/card', options)
          command.response_representation = Google::Apis::CloudbillingV1::AgentCard::Representation
          command.response_class = Google::Apis::CloudbillingV1::AgentCard
          command.query['tenant'] = tenant unless tenant.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
