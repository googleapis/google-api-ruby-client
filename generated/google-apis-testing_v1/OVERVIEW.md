# Legacy REST client for version V1 of the Cloud Testing API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Testing service in particular.)
