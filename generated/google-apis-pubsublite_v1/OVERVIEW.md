# Legacy REST client for version V1 of the Pub/Sub Lite API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Pubsublite service in particular.)
