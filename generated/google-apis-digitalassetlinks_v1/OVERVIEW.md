# Legacy REST client for version V1 of the Digital Asset Links API
...
(Note: the above documents are written for the legacy clients in general, and their examples may not reflect the Digitalassetlinks service in particular.)
