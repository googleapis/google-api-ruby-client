require File.expand_path("lib/google/apis/admob_v1beta/gem_version", __dir__)
gem_version = Google::Apis::AdmobV1beta::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-admob_v1beta"
  ...
  gem.description =
      ...
      " this client to access the AdMob API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-admob_v1beta/v#{gem_version}",
