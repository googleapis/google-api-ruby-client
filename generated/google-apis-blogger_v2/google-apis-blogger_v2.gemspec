...
Gem::Specification.new do |gem|
  ...
  gem.version = Google::Apis::BloggerV2::GEM_VERSION
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Blogger API v3 V2"
  gem.description =
      "This is the simple REST client for Blogger API v3 V2." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-blogger_v2/v#{Google::Apis::BloggerV2::GEM_VERSION}",
